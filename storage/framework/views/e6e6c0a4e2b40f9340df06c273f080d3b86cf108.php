...
<h1>
    <?php echo e(trans('sellManage.S_MainTitle')); ?><!--<small>明細一覽｜座席圖</small>-->
</h1>
<!-- 網站導覽 -->
<ol class="breadcrumb">
    <li><a href="/sell" onclick="loading.openLoading()"><?php echo e(trans('sellManage.S_SubTitle_1')); ?></a></li>
    <li><a href="/sell/manage/<?php echo e($eventsInf['data']['performanceId']); ?>" onclick="loading.openLoading()"><?php echo e(trans('sellManage.S_SubTitle_2')); ?></a></li>
    <li class="active"><?php echo e($SaleManagePresenter->getSeatSettingTitle($eventsInf['data']['seatmap_profile_cd'])); ?></li>
</ol>
<!-- /.網站導覽 -->
    ...
    <div class="box-body">
        ...
        <div class="row-group-grid">
            ...
            <div class="row ">
                ...
                <div class="col-xs-10 col-sm-10 grid-text"><?php echo e($eventsInf['data']['performanceName']); ?></div>
            </div>
            <!-- /.Row1 -->
           ...
           <!-- Row2 -->
             <div class="row ">
                ...
                <div class="col-xs-10 col-sm-10 grid-text"><?php echo e($eventsInf['data']['date']); ?> <?php echo e($SaleManagePresenter->timeTransform($eventsInf['data']['time'])); ?></div>
            </div>
             <!-- /.Row2 -->
            <!-- 2021/06/23 STS - Task 24  -- END -->
            <!-- Row3 -->
            <div class="row <?php echo e(($eventsInf['data']['performanceStatuc'] == 7)? 'bg-yellow':''); ?>">
                <div class="col-xs-2 col-sm-2 grid-title"><?php echo e(trans('sellManage.S_EventChangedate')); ?></div>
                <div class="col-xs-10 col-sm-10 grid-text form-group form-group-fix">
                    ...
                    <div class="input-group date col-lg-3 col-sm-4 col-xs-12">
                        ...
                        <!-- <input type="text" class="form-control pull-right" value="<?php echo e($eventsInf['data']['date']); ?>" readonly> -->
                    ...
                    <div class="bootstrap-timepicker col-lg-2 col-sm-3">
                        <div class="input-group">
                            ...
                            <!-- <input type="text" class="form-control timepicker" value="<?php echo e($SaleManagePresenter->timeTransform($eventsInf['data']['time'])); ?>" readonly> -->
                    ...
                    <div class="mr-auto">
                        <button id="searchBtn" type="button" class="btn btn-info-outline btn-mm"> 
                            <?php echo e(trans('sellManage.S_EventMove')); ?>

                        </button>
                        <?php if($eventsInf['data']['performanceStatuc'] == 7): ?>
            ...
            <div class="row form-horizontal box-title-block">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <?php echo e(trans('events.S_SeatTotal')); ?>
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">
                        <?php echo e(trans('events.S_SeatSell')); ?>
                ...
                <div class="row">
                    ...
                    <div class=" col-md-12 card-wrap">
                        <template v-for="(data, index) in typeSeat">
                            <div class="col-lg col-md-3 col-sm-4 mb-4" v-if="data.seat_class_kbn == <?php echo \Config::get('constant.seat_class_kbn.reserved'); ?> && data.status !== 'D'">
                                <div class="stats-small card card-small" :style="{backgroundColor: data.seat_class_color}">
                                    <div class="card-body ">
                                        ...
                                        <div class="stats-small__form-group">
                                            ...
                                            <div class="num-block w-70" :style="{color :seatCardStyle(data.seat_class_color)}" >{{ data.typeSell }}/{{ data.typeTotal }} <?php echo e(trans('events.S_SeatUnit')); ?></div>
                                            <!--/.20200903 新增與調整-->
                                        </div>
                                        </div>
                                        </div>
                            ...
                            <div class="col-lg col-md-3 col-sm-4 mb-4" v-if="data.seat_class_kbn == <?php echo \Config::get('constant.seat_class_kbn.unreserved'); ?> && data.status !== 'D'">
                                    ...
                                    <div class="card-body">
                                        <div class="flex-column m-auto">
                                            ...
                                            <div class="stats-small__form-group">
                                                ...
                                                <!--<div class="form-flex">
                                                    <input type="" class="form-control in-small border__blue" id="" placeholder="<?php echo e(trans('events.S_feeSeatType')); ?>" disabled="disabled">
                                                </div>-->
                                                ...
                                                <div class="form-flex num-block w-50">{{ data.typeSell }}/{{ data.typeTotal }} <?php echo e(trans('events.S_SeatUnit')); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="stats-small__form-group">
                                                <div class="stats-small__forms stats-small_forms__1">
                                                    ...
                                                    <div class="form-flex w-70">
                                                        <div class="stats-small__form-group">
                                                            <div class="stats-small__forms stats-small_forms__1">
                                                                <div class="">{{ data.order_total }}/{{ data.total }} <?php echo e(trans('events.S_SeatUnit')); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row form-horizontal">
                                <div class="col-md-12 floor-content">
                                    <div class="col-md-4 floor-map">
                                        <h5 class="text-center mb-4"><?php echo e(trans('events.S_venuePicTitle')); ?></h5>
                                    ...
                                    <div class="col-md-8 floor-direction">
                                        <h5 class="text-center mb-4"><?php echo e(trans('events.S_blockListTitle')); ?>
                                ...
                                <h5 class="text-center floor-settings-title">
                                    <?php echo e(trans('events.S_seatSettingTilte')); ?> - {{ nowFloor }} {{ nowBlock }}
                                    <!---圖例--->
                          <div class="toolkey-box">
                            <a class="toolkey btn-key">
                              <div class="toolkey-text"><?php echo e(trans('events.S_seatSymbol')); ?></div>
                              <div class="toolkey-left">
                                <div class="row" >
                                  <div class="col-sm-3"><img src="/assets/images/seat/i-seat-order.svg"><?php echo e(trans('events.S_seatReserved')); ?></div>
                                  <div class="col-sm-3"><img src="/assets/images/seat/i-seat-pay.svg"><?php echo e(trans('events.S_seatPayment')); ?></div>
                                  <div class="col-sm-3"><img src="/assets/images/seat/i-seat-sold.svg"><?php echo e(trans('events.S_seatSold')); ?></div>
                                 <!-- <div class="col-sm-3"><img src="/assets/images/seat/i-seat-situation.svg"><?php echo e(trans('events.S_seaPrblemt')); ?></div> -->
                                </div>
                              </div>
                            </a>
                          </div>
                                ...
                                <div class="row floor-settings">
                                    <div class="col-md-12 d-flex-bt">
                                        <div class="form-group form-d-flex">
                                            ...
                                            <label class="d-h-spec">{{ nowUnitTotal }}<?php echo e(trans('events.S_SeatUnit')); ?></label>
                                            <!-- /.input group -->
                                            <div class="floor-btn-group" v-bind:style="{ visibility: (statuc == 7)?'hidden':'' }">
                                                <button type="button" class="btn btn-info" v-on:click="saveSeatIsSelect()" :disabled="settingBtn"><?php echo e(trans('events.S_btnSeatSetup')); ?></button>
                                                <button type="button" class="btn btn-inverse" v-on:click="clearSeatIsSelect()"><?php echo e(trans('events.S_btnSeatRelease')); ?></button>
                                            </div>
                                        </div>
                                        <!-- 方向表示 -->
                                    ...
                                    <div v-else class="d-block-arrow"><i class="far fa-arrow-alt-circle-up"></i></div>
                                        ...
                                        <div class="form-group form-d-flex ">
                                            <div class="floor-btn-group">
                                                <button type="button" class="btn btn-default" :disabled="zoomOutBtn" @click="zoomOutTable"><?php echo e(trans('events.S_btnZoomin')); ?></button>
                                                <button type="button" class="btn btn-default" :disabled="zoomInBtn"  @click="zoomInTable"><?php echo e(trans('events.S_btnZoomout')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
    ...
    <transition name="slide-fade">  
        <div class="modal-mask" v-show='showModal'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo e(trans('events.S_setReserved')); ?></h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-horizontal">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label"><?php echo e(trans('events.S_reserveNameTitle')); ?></label>
                                        <div class="col-md-10">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-md-2 control-label"><?php echo e(trans('events.S_reserveSymbol')); ?></label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="" class="btn btn-inverse" @click="addSpecTicket()"><?php echo e(trans('basisInf.S_Apply')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
var dates = []
var scheduleList = JSON.parse('<?php echo json_encode($events["schedule_inf"]); ?>');
...
$('#searchDate').daterangepicker({
    ...
    startDate: "<?php echo e($eventsInf['data']['date']); ?>",
...
function onDateChange(date) {
    let scheduleTime = "<?php echo e($eventsInf['data']['time']); ?>"
    let scheduleDate = "<?php echo e($eventsInf['data']['date']); ?>"
    let draftId = "<?php echo e($eventsInf['data']['draftId']); ?>"
    let options = ''
...
const seatMapSetting = new Vue({
    ...
    mounted:function(){
        sessionStorage.setItem('sellMapData','<?php echo addslashes(json_encode($eventsInf)); ?>')
        let sellMapData = JSON.parse(sessionStorage.getItem("sellMapData"))
        this.dateValue = "<?php echo e($eventsInf['data']['date_value']); ?>"
        this.publish = "<?php echo e($eventsInf['data']['publish_status']); ?>"
        this.ruleId = "<?php echo e($eventsInf['data']['rule_id']); ?>"
        ...
        onDateChange('<?php echo e($eventsInf['data']['date']); ?>') //2021-06-23 STS - TASK 24
    ...
    methods: {
        ...
        seatSettingInf:function(){
            ...
            if(this.typeSeat){
                this.typeSeat.forEach(function(element) {
                    if(element.seat_class_kbn == <?php echo \Config::get('constant.seat_class_kbn.reserved'); ?>){
        ...
        countSeatSelect:function(){
            ...
            this.typeSeat.forEach(function(data, index, arr){
                if(data.seat_class_kbn == <?php echo addslashes(\Config::get('constant.seat_class_kbn.reserved')); ?>){
...
$('#updateBtn').click(function (e) {
    ...
    if(checkInf){
        ...
        json.push({
            publish : "<?php echo e($eventsInf['data']['publish_status']); ?>",
            performanceId : <?php echo e($eventsInf['data']['performanceId']); ?>,
            draftId : <?php echo e($eventsInf['data']['draftId']); ?>,
            dateValue : <?php echo e($eventsInf['data']['date_value']); ?>,
            ruleId : <?php echo e($eventsInf['data']['rule_id']); ?>,
            scheduleId : <?php echo e($eventsInf['data']['scheduleId']); ?>,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\GettiiLite (9)New\resources\views/frontend/sell/seat.blade.php ENDPATH**/ ?>