    ...
    <div class="box no-border">
     ...
     <div class="box no-border">
      <div class="box-header">
        ...
        <p class="margin-fix"><span class="text-gray"><?php echo e(trans('report.S_Distributor')); ?> ｜ </span> <?php echo e($user['data']['user_data']['contract_name']); ?></p>
      </div>
    </div>   
    <div class="box no-border">
      <div class="box-body">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\GettiiLite (9)New\resources\views/frontend/report/sysreport.blade.php ENDPATH**/ ?>