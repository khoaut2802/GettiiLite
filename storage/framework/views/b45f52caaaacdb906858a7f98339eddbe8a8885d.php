...
<?php $__env->startSection('content_header'); ?>
    <h1>
        <?php echo e(trans('sellManage.S_SubTitle_3')); ?>

        
    </h1>
    <ol class="breadcrumb">
        <li><a href="/sell" onclick="loading.openLoading()"><?php echo e(trans('sellManage.S_SubTitle_1')); ?></a></li>
        <li><a href="/sell/manage/<?php echo e($event['performanceId']); ?>" onclick="loading.openLoading()"><?php echo e(trans('sellManage.S_SubTitle_2')); ?></a></li>
        <li class="active"><?php echo e(trans('sellManage.S_SubTitle_3')); ?></li>
    </ol>
<?php $__env->stopSection(); ?>
...
<div id="app" class="content-navonly">
    ...
    <ul id="" class="nav nav-tabs-sell">
        <li class="active">
            <a id="" href="/sell" onclick="loading.openLoading()"><span><?php echo e(trans('sellManage.S_sellInfoTab_01')); ?></span></a>
        </li>
        <li>
            <a id="" href="/orders" onclick="loading.openLoading()"><span><?php echo e(trans('sellManage.S_sellInfoTab_02')); ?></span></a>
        </li>
    </ul>
    <!-- /.新增子選單 -->
    <div>
<div id="orderDetail">
    <form id="getCsv" method="GET" action="csv/<?php echo e($event['scheduleId']); ?>">
    ...
    <form id="sendSeatInf" method="POST" action="/sell/resSeatSetting">
        ...
        <input type="hidden" name="json" v-model="json">
        <input type="hidden" name="page" value="<?php echo e($event['page']); ?>">
        <input type="hidden" name="filterJson" v-model="filterJson">
    </form>
    ...
    <form id="orderCancel" method="POST" action="/sell/orderCancel/<?php echo e($event['scheduleId']); ?>">
        <?php echo e(csrf_field()); ?>
    ...
    <form id="reviseAmount" method="POST" action="/sell/reviseAmount/<?php echo e($event['scheduleId']); ?>">
        <?php echo e(csrf_field()); ?>
    ...
    <form id="filterOrder" method="GET" action="/sell/detail/<?php echo e($event['scheduleId']); ?>">
        <?php echo e(csrf_field()); ?>
    ...
    <div class="box box-solid">
        <div class="box-body">
            ...
            <div class="row-group-grid">
                <!-- Row1 -->
                <div class="row ">
                    <div class="col-xs-2 col-sm-2 grid-title"><?php echo e(trans('sellManage.S_EventTitle')); ?></div>
                    <div class="col-xs-6 col-sm-10 grid-text"><?php echo e($event['perfomanceTitle']); ?></div>
                </div>
                <!-- /.Row1 -->
                <!-- Row2 -->
                <div class="row">
                    <div class="col-xs-2 col-sm-2 grid-title"><?php echo e(trans('sellManage.S_EventOpenDate')); ?></div>
                    <div class="col-xs-4 col-sm-4 grid-text"><?php echo e($event['openDate']); ?></div>
                    <div class="col-xs-2 col-sm-2 <?php echo e(($event['performance_status'] == '7')?'bg-yellow':''); ?> grid-title"><?php echo e(trans('sellManage.S_EventOpenTime')); ?></div>
                    <div class="col-xs-4 col-sm-4 <?php echo e(($event['performance_status'] == '7')?'bg-yellow':''); ?> grid-text"><?php echo e($SaleManagePresenter->timeTransform($event['openTime'])); ?></div>
                </div>
                <!-- /.Row2 -->
            </div>
        </div>
        <div class="box-footer text-right">
            <?php if(!is_null($event['seatmap_profile_cd'])): ?>
                <a href="/sell/seat/<?php echo e($event['scheduleId']); ?>" class="btn waves-effect waves-light btn-angle btn-inverse-outline"><?php echo e(trans('sellManage.S_EventSeatImage')); ?></a>
            <?php endif; ?>
            <button type="button" v-on:click="csvEx()"  class="btn waves-effect waves-light btn-angle btn-inverse"><?php echo e(trans('sellManage.S_CsvButton')); ?></button>
        </div>       
    </div>
    <!-- /.FORMGROUP 2  Grid + BTN  -->
    ...
    <div class="box no-border collapsed-box">
            ...
            <div class="form-horizontal form-bordered">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input name="keyword" type="text" placeholder="<?php echo e(trans('sellManage.S_PleaseInputKeyword')); ?>" class="form-control" v-model="keyword">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button type="button" v-on:click="dateClear()"  class="btn waves-effect waves-light btn-inverse"><?php echo e(trans('sellManage.S_BtnClear')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-2"><?php echo e(trans('sellManage.S_EventDetailSeatName')); ?></label>
                        <div class="col-md-4">
                            <select id="n" name="seat" class="form-control" style="width: 100%;" v-model="seatType">
                                <option value="all"><?php echo e(trans('sellManage.S_StatusAll')); ?></option>
                                <template v-for="data in seatOption">
                                    <option :value="data">{{ data }}</option>
                                </template>
                            </select>
                        </div>
                        <label class="control-label col-md-2"><?php echo e(trans('sellManage.S_EventDetailTicketName')); ?></label>
                        <div class="col-md-4">
                            <select name="ticket" class="form-control" style="width: 100%;" v-model="fTicketType">
                                <option selected="selected" value="all"><?php echo e(trans('sellManage.S_StatusAll')); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 control-label-checkbox">
                            ...
                            <label class="control control--checkbox">
                                ...
                                <div class="control__indicator"></div>
                                <?php echo e(trans('sellManage.S_Pickup_NoTicketing')); ?>
        ...
        <!-- /.box-body -->
        <div class="box-footer text-right">
            <button v-on:click="sreachData()" class="btn waves-effect waves-light btn-angle btn-info"><?php echo e(trans('sellManage.S_InquireButton')); ?></button>
        </div>
    </div>
    <!-- /.box - 檢索 -->
    ...
    <div class="box box-solid" >
        ...
        <?php if((\App::getLocale() != "ja" )): ?>
            ...
            <div class="tip"><span data-tooltip="<?php echo e(trans('sellManage.S_TickettingTooltip')); ?>"><i class="fas fa-info fa-1x"></i></span></div>
            <div class="w-20">
                <div class="mmlr-1">
                    <select id="evenType" name="evenType" class="form-control" aria-required="true" aria-invalid="false" v-model="freeSeatType">
                        <option  class="not-select" value="-1" disabled hidden><?php echo e(trans('sellManage.S_TickettingNote')); ?></option> 
                        <option v-for="(event,index) in freeSeatInt" v-bind:value="index">{{event.inf.seatTitle}}</option>  
                        </select> 
                    </div>
                </div>
                <button :disabled="freeSeatType === -1" class="btn btn-info btn-ml" v-on:click="openTicketSetting( 0, 0, 1, 'freeSeat')"><?php echo e(trans('sellManage.S_Ticketting')); ?></button>
            </div>
        <?php endif; ?>
        <!--   -->
        <div class="box-body" >
            ...
            <!-- TABLE 5 / Toggle Footable -->
                    ...
                    <table class="table table-condensed tablesaw no-wrap tablesaw-sortable tablesaw-swipe" style="border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <th><?php echo e(trans('sellManage.S_EventDetailTableName')); ?></th>
                            <th><?php echo e(trans('sellManage.S_EventDetailTableTel')); ?></th>
                            <th><?php echo e(trans('sellManage.S_EventDetailTableMail')); ?></th>
                            <th><?php echo e(trans('sellManage.S_EventDetailTablePay')); ?></th>
                            <th><?php echo e(trans('sellManage.S_EventDetailTableGet')); ?></th>
                            ...
                            <th class="text-right"><?php echo e(trans('sellManage.S_EventDetailTableTotal')); ?></th>
                        ...
                        <tbody>
                          <tr class="editblocks">
                            ...
                            <td v-if="(inf['member_id']) === 'gettiis$[N_M]'"><?php echo e(trans('sellManage.S_EventDetailNoneMember')); ?></td>
                            ...
                            <td v-else-if="inf['pay_method'] === 1"><?php echo e(trans('sellManage.S_EventDetailCash')); ?></td>
                            <td v-else-if="inf['pay_method'] === 2"><?php echo e(trans('sellManage.S_EventDetailCreditCard')); ?></td>
                            <td v-else-if="inf['pay_method'] === 31">ibon</td>
                            <td v-else-if="inf['pay_method'] === 3"><?php echo e(trans('sellManage.S_EventDetailConvenience')); ?></td>
                            <td v-else-if="inf['pay_method'] === 20"><?php echo e(trans('sellManage.S_EventDetailFree')); ?></td>
                            <td v-else-if="inf['pay_method'] === 4">-</td>
                            <td v-else>-</td>
                            <td v-if="inf['pickup_method'] === -1">X</td>
                            <td v-else-if="inf['pickup_method'] === 9"><?php echo e(trans('sellManage.S_EventDetailPickup_ET')); ?></td>
                            <td v-else-if="inf['pickup_method'] === 91">QR PASS</td>
                            <td v-else-if="inf['pickup_method'] === 31"><?php echo e(trans('sellManage.S_Pickup_Ibon')); ?></td>
                            <td v-else-if="inf['pickup_method'] === 3"><?php echo e(trans('sellManage.S_EventDetailConvenience')); ?></td>
                            <td v-else-if="inf['pickup_method'] === 8"><?php echo e(trans('sellManage.S_Pickup_Resuq')); ?></td>
                            <td v-else-if="inf['pickup_method'] === 99"><?php echo e(trans('sellManage.S_Pickup_NoTicketing')); ?></td>
                            <td v-else-if="inf['pickup_method'] === 4">-</td>
                            <td v-else>-</td>
                            <td v-if="inf['payment_flg'] === 0"><?php echo e(trans('sellManage.S_EventDetailNoHad')); ?></td>
                            <td v-else-if="inf['payment_flg'] === 1"><?php echo e(trans('sellManage.S_EventDetailHad')); ?></td>
                            <td v-else-if="inf['payment_flg'] === 2"><?php echo e(trans('sellManage.S_EventDetailHad')); ?>※</td>
                            <td v-else>-</td>
                            <td v-if="inf['issue_flg'] === 0"><?php echo e(trans('sellManage.S_EventDetailNotGet')); ?></td>
                            <td v-else-if="inf['issue_flg'] === 1"><?php echo e(trans('sellManage.S_EventDetailGot')); ?></td>
                            <td v-else-if="inf['issue_flg'] === 2"><?php echo e(trans('sellManage.S_EventDetailGot')); ?>※</td>
                            <td v-else>-</td>
                            <td>{{ inf['visit_flg'] }}</td>
                            <td>-</td>
                            <!-- 1219 新增 class="text-right"-->
                              ...
                              <div class="togglesettings">
                                ...
                                <!-- 訂單金額修改按鈕 -->
                                    <button v-if="inf['revise_amount']['data']['status']" class="btn btn-danger pull-right margin-10"  v-on:click="openReviseAmount(index, inf['order_id'], 2, 'reviseAmount', 'Inf')">
                                        <?php echo e(trans('sellManage.S_ReserveChangeDetail')); ?>
                                    ...
                                    <button v-if="inf['revise_amount']['reviseStatus'] && (inf['issue_flg'] === 0 || (inf['pickup_method'] === 9 && inf['issue_flg'] !== 0)) && ( ( inf['pay_method'] === 3 && inf['payment_flg'] === 0 ) || (inf['pay_method'] === 31))" class="btn btn-danger pull-right margin-10"  v-on:click="openReviseAmount(index, inf['order_id'], 1, 'reviseAmount', 'revise')">
                                        <?php echo e(trans('sellManage.S_ReserveChange')); ?>
                                ...
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>入場</th>
                                        <th v-if="inf['order_type'] == 2"><?php echo e(trans('sellManage.S_EventDetailTableFllorBlock')); ?></th>
                                        <th v-else><?php echo e(trans('sellManage.S_EventDetailSeatName')); ?></th>
                                        <th v-if="inf['order_type'] == 2"><?php echo e(trans('sellManage.S_EventDetailSeatPosition')); ?></th>
                                        <th v-else><?php echo e(trans('sellManage.S_EventDetailTicketName')); ?></th>
                                        <th v-if="inf['order_type'] == 2"><?php echo e(trans('member.S_MemberName')); ?></th>
                                        <th v-else><?php echo e(trans('sellManage.S_EventDetailSeatType')); ?></th>
                                        <th v-if="inf['order_type'] == 2"><?php echo e(trans('sellManage.S_Pickuptype')); ?></th>
                                        <th v-else><?php echo e(trans('sellManage.S_EventDetailSeatPosition')); ?>  / <?php echo e(trans('sellManage.S_EventDetailReferencenNumber')); ?></th>
                                        <!-- 1219 新增 class="text-right"-->
                                        <th v-if="inf['order_type'] == 2"><?php echo e(trans('sellManage.S_EventDetailTableTicketingDate')); ?></th>
                                        <th v-else class="text-right"><?php echo e(trans('sellManage.S_EventDetailTableTP')); ?></th>
                                ...
                                <tbody v-for="(data, no) in inf['seatData']">
                                    <tr>
                                        ...
                                        <template v-else>
                                            <td v-if="data['seatType'] === 1"><?php echo e(trans('sellManage.S_EventDetailSelectSeat')); ?></td>
                                            <td v-else-if="data['seatType'] === 'R'"><?php echo e(trans('sellManage.S_EventDetailFreeSeat')); ?></td>
                                            <td v-else-if="data['seatType'] === 3"><?php echo e(trans('sellManage.S_EventDetailRetainSeat')); ?></td>
                                            <td v-else></td>
                                        </template>
                                        <template v-if="inf['order_type'] == 2">{{ data['inf']['pickup_method'] }}
                                            <td v-if="data['orderInf']['pickup_method'] === -1">X</td>
                                            <td v-else-if="data['orderInf']['pickup_method'] === 9"><?php echo e(trans('sellManage.S_EventDetailPickup_ET')); ?></td>
                                            <td v-else-if="data['orderInf']['pickup_method'] === 91">QR PASS</td>
                                            <td v-else-if="data['orderInf']['pickup_method'] === 8"><?php echo e(trans('sellManage.S_Pickup_Resuq')); ?></td>
                                            <td v-else-if="data['orderInf']['pickup_method'] === 99"><?php echo e(trans('sellManage.S_Pickup_NoTicketing')); ?></td>
                                            <td v-else-if="data['orderInf']['pickup_method'] === 31"><?php echo e(trans('sellManage.S_Pickup_Ibon')); ?></td>
                                            <td v-else-if="data['orderInf']['pickup_method'] === 3"><?php echo e(trans('sellManage.S_EventDetailConvenience')); ?></td>
                                        ...
                                        <td class="text-right" v-if="data['seatType'] === 3 && data['orderInf']['status'] === 1 && !performance_disp_status">
                                          <?php if((\App::getLocale() == "zh-tw" )): ?>
                                            ...
                                            <button class="btn btn-info-outline btn-m btn-w90" v-on:click="openTicketSetting(index, no, data['orderInf']['status'])">
                                                <?php echo e(trans('sellManage.S_Ticketting')); ?>
                                        ...
                                        <td class="text-right" v-else-if="data['seatType'] === 3 && data['orderInf']['status'] === 2">
                                            ...
                                            <button class="btn btn-inverse-outline btn-m btn-w90" v-on:click="openTicketSetting(index, no, 3)">
                                                <?php echo e(trans('sellManage.S_TickettingDetail')); ?>

                                            </button>
                                        </td>
                                        <td v-if="getVisitButtonFlg(inf)"><!-- 0412新增 入場/取消入場按鈕 -->
                                            <template v-if="getVisitFlg(data['visit_flg']) == 2">
                                                <button class="btn btn-info-outline btn-mm pull-right" v-on:click="openPopResult(data['seat_sale_id'], true)"><?php echo e(trans('sellManage.S_Admission')); ?></button>
                                            </template>
                                            <template v-if="getVisitFlg(data['visit_flg']) == 1">
                                                <button class="btn btn-inverse-outline btn-mm pull-right" v-on:click="openPopResult(data['seat_sale_id'], false)"><?php echo e(trans('sellManage.S_AdmissionCancel')); ?></button>
                                            </template>
                                        </td>
                                        <td v-else>
                                        </td>
                                ...
                                <tr v-show="inf['order_type'] != 2 && 0 < questionnaires.length">
                                    <td>
                                        <table class="table color-bordered-table success-bordered-table pull-right">
                                            <thead>
                                                <tr>
                                                    <th width="20%"><?php echo e(trans('sellManage.S_FreeQuestionTitle')); ?></th>
                                                    <th width="30%"><?php echo e(trans('sellManage.S_FreeQuestionDesc')); ?></th>
                                                    <th width="50%"><?php echo e(trans('sellManage.S_FreeQuestionAns')); ?></th>
                                                </tr>
                                            </thead>
                        ...
                        <tfoot class="tfoot-light">
                            ...
                            <th colspan="13" class="text-center">
                                <?php if(!is_null($event['paginator'])): ?>
                                    小計
                                <?php else: ?>
                                    <?php echo e(trans('sellManage.S_TableTotal')); ?>
                    ...
                    <?php if(!is_null($event['paginator'])): ?>
                        ...
                        <div class="col-sm-12">
                            <nav aria-label="Page navigation" class="pull-right">
                                <?php echo e($event['paginator']->links()); ?>
                ...
                <div class="modal-header">
                    <!--出票-->
                        <template v-if="dialogType == 'draw'">        
                            ...
                            <h4 class="modal-title" v-show="step == '1'">
                                <?php echo e(trans('sellManage.S_TicketingNotice_1')); ?>

                            </h4>
                            <!-- form  step 1-->
                            <!-- form  step 2-->
                            <h4 class="modal-title" v-show="step == '2' && !isInsert">
                                <?php echo e(trans('sellManage.S_TicketingNotice_2')); ?>

                            </h4>
                            <!-- form  step 2-->
                            <!-- form  step 3-->
                            <h4 class="modal-title" v-show="step == '3'">
                                <?php echo e(trans('sellManage.S_TicketingNotice_3')); ?>
                    ...
                    <!--訂單取消-->
                        <template v-if="dialogType == 'orderCancel'">        
                            ...
                            <h4 class="modal-title" v-show="step == '2'" v-if="dialogType == 'orderCancel'">
                                 <?php echo e(trans('sellManage.S_ReserveCancelDetail')); ?>
                    ...
                    <!--訂單金額修改-->
                        <template v-if="dialogType == 'reviseAmount'">        
                            ...
                            <h4 class="modal-title" v-show="step == '2' && process == 'revise'">
                                 <?php echo e(trans('sellManage.S_ReserveChangeConfirm')); ?>
                    ...
                    <!--統一頁-->
                        ...
                        <h4 class="modal-title" v-show="step == '-2' || step == '-3'">
                            <template v-if="dialogType == 'reviseAmount'">
                                <?php echo e(trans('sellManage.S_ReserveChangeResult')); ?>
                            ...
                            <template v-else>
                                <?php echo e(trans('sellManage.S_TicketingNotice_4')); ?>
                        ...
                        <h4 class="modal-title" v-show="step == '-1'">
                           <?php echo e(trans('sellManage.S_TicketingNotice_7')); ?>
                    ...
                    <!--出票-->
                        <template v-if="dialogType == 'draw'">
                            ...
                            <div class="row form-horizontal" v-show="step == '1'">
                                ...
                                <!-- 會員查詢 -->
                                    <div class="form-group mt-4">
                                        ...
                                        <div class="col-md-12">  
                                            <div class="input-group">
                                                <input type="text" class="form-control pull-right" id="memberSearch"  placeholder="<?php echo e(trans('sellManage.S_TicketingPlacehokder')); ?>" v-model="memberKeyword" v-on:keyup.enter="memberSearch()">
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn waves-effect waves-light btn-inverse" v-on:click="memberSearch()"><?php echo e(trans('sellManage.S_SearchBtn')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-result" v-show="showMembersInf && !search_loading">
                                        <h5><?php echo trans('sellManage.S_TicketingSearch', ['keyword' => '{{memberKeyword}}','total' => '{{membersTotal}}','showtotal' => '{{membersShowTotal}}']); ?></h5>
                                        <!-- 被選取的tag樣式請使用 active -->
                                        <p>
                                ...
                                <div class="col-md-12">
                                    <div class="modal-overflow">
                                        <ul class="modal-list-non mmlr-1 box-light">
                                            <li>
                                                <div class="col-md-3">
                                                <b><?php echo e(trans('sellManage.S_EventDetailTableId')); ?> / <?php echo e(trans('member.S_MemberName')); ?></b>
                                        ...
                                        <div class="modal-result">
                                            <h5 class="mlb-1">
                                                ...
                                                <?php echo e(trans('sellManage.S_TicketingNotice_5')); ?>

                                            </h5>
                                            <div class="form-group" >
                                                <label class="col-md-2 control-label"><?php echo e(trans('sellManage.S_TicketingType')); ?></label>
                                                <div class="col-md-10 form-group-flex mtb-1">
                                                    <div class="form-checkbox">
                                                        <label class="control control--radio">
                                                            ...
                                                            <?php echo e(trans('sellManage.S_EventDetailPickup_ET')); ?>
                                                    ...
                                                    <?php if((\App::getLocale() == "zh-tw" )): ?>
                                                      <div class="form-checkbox">
                                                          <label class="control control--radio">
                                                              ...
                                                              <?php echo e(trans('sellManage.S_EventDetailQrpass')); ?>
                                                    ...
                                                    <?php if((\App::getLocale() == "ja" )): ?>
                                                      ...
                                                      <div class="form-checkbox">
                                                          <label class="control control--radio">
                                                              ...
                                                              <?php echo e(trans('sellManage.S_EventDetailResuq')); ?>
                                            ...
                                            <ul class="modal-list-non mmlr-1 box-light">
                                                <li>
                                                    <b class="col-md-2"><?php echo e(trans('sellManage.S_EventDetailTableTel')); ?></b>{{phoneNum}}
                                                </li>
                                                <li>
                                                    <b class="col-md-2">EMail</b>{{mail}}
                                                </li>
                                                <li v-show="pickupMethod == 'mobapass'">
                                                    <b class="col-md-2"><?php echo e(trans('sellManage.S_EventDetailPickup_ET')); ?> ID</b>{{mobapassId}}
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- /.資訊顯示 -->
                            ...
                            <div class="row form-horizontal" v-show="step == 3">
                                <div class="col-md-12">
                                    <h4 class="text-red"><i class="fas fa-exclamation-triangle"></i>  <?php echo e(trans('sellManage.S_TicketingNotice_6')); ?></h4>
                                        <div class="modal-overflow">
                                            <!-- 會員資訊呈現 -->
                                            <ul class="modal-list">
                                                <li>
                                                    <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailSeatName')); ?></span>{{seatTitle}} 
                                                </li> 
                                                <li>
                                                    <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailSeatPosition')); ?></span>{{seatPosition}}
                                                </li> 
                                                <li>
                                                    <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_Pickuptype')); ?></span>{{pickupMethodTitle}}
                                                </li>   
                                                <li>
                                                    <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailTableTel')); ?></span>{{phoneNum}} 
                                                </li>
                                                <li>
                                                    <span class="badge bg-gray-light">Email</span>{{mail}}
                                                </li>
                                                <li v-show="pickupMethod == 'mobapass'" >
                                                    <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailPickup_ET')); ?> id</span>{{mobapassId}}
                                                </li>
                                            </ul> 
                                            <!-- /.會員資訊呈現 --> 
                                        </div>
                    ...
                    <!--訂單取消-->
                        <template v-if="dialogType == 'orderCancel'">
                            <div class="row form-horizontal" v-show="step == '1'">
                                <div class="col-md-12">
                                    <h4 class="">
                                        ...
                                        <?php echo trans('sellManage.S_ReserveCancelNotice1', ['reserve_no' => '{{reserve_no}}']); ?>
                                    ...
                                    <div class="flex-start i-memo-blue"><?php echo e(trans('sellManage.S_ReserveCancelNotice2')); ?> {{ reserve_date }}</div>
                                        <div class="modal-overflow overflow-x-hidden">
                                            <template v-if="refund_kbn == '<?php echo e(\Config::get('constant.pay_method.card')); ?>'">
                                                <!-- 信用卡請使用以下 -->
                                                <ul class="modal-list">
                                                    <li>
                                                        <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_RefundCard')); ?></span>  
                                                    </li> 
                                                </ul>
                                            </template>
                                            <template v-else-if="refund_kbn == '<?php echo e(\Config::get('constant.pay_method.store')); ?>'">
                                                <!-- SEJ請使用以下 -->
                                                <ul class="modal-list">
                                                    <li>
                                                        <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_RefundSEJ')); ?></span>  
                                                    </li> 
                                                </ul>
                                            </template>
                                            <template v-else-if="refund_kbn == '<?php echo e(\Config::get('constant.pay_method.free')); ?>'">
                                                <!-- SEJ請使用以下 -->
                                                <ul class="modal-list">
                                                    <li>
                                                        <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailFree')); ?></span>  
                                                    </li> 
                                                </ul>
                                            </template>
                                            <template v-else>
                                                <!-- 1 -->
                                                    <div class="form-group form-group-flex">
                                                        ...
                                                        <div class="col-md-3">
                                                            <?php if(\App::getLocale() == "ja" ): ?>
                                                                <input dusk="bankName1" type="text" class="form-control" maxlength="4" placeholder="<?php echo e(trans('sellManage.S_RefundBankCode')); ?>" @change="bankCodeChange($event)" v-model="bankCode">
                                                            <?php else: ?>
                                                                <input dusk="bankName1" type="text" class="form-control" maxlength="3" placeholder="<?php echo e(trans('sellManage.S_RefundBankCode')); ?>" @change="bankCodeChange($event)" v-model="bankCode">
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <!-- 2 -->
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input dusk="bankName2" type="text" class="form-control"  placeholder="<?php echo e(trans('sellManage.S_RefundBankBranch')); ?>" v-model="branchName">
                                                        </div>
                                                    </div>
                                                <!-- /.2 --> 
                                                <!-- 3 -->
                                                ...
                                                <div class="form-group">
                                                    <div class="ml-70x">
                                                        <?php if(session()->get('full_refund')): ?>
                                                            <div class="form-checkbox">
                                                                <label class="control control--radio">
                                                                <input type="radio" name="all" value="fullRefund" v-on:change="setFullRefund" v-model="fullRefund"><?php echo e(trans('sellManage.S_FullRefund')); ?>
                                                            ...
                                                            <div class="form-checkbox">
                                                                <label class="control control--radio">
                                                                <input type="radio" name="all" value="basisRefund" v-on:change="setFullRefund" v-model="fullRefund"><?php echo e(trans('sellManage.S_PartialRefund')); ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <span v-if="refundTextDisplay" class="help-block text-blue text-right"><?php echo e(trans('sellManage.S_ReserveCancelNotice4')); ?></span>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row form-horizontal" v-show="step == '2'">
                                <div class="col-md-12">
                                    <h4 class="text-red">
                                        <i class="fas fa-exclamation-triangle"></i>  <?php echo e(trans('sellManage.S_ReserveCancelNotice5')); ?>

                                    </h4>
                                    <div class="modal-overflow">
                                        <ul class="modal-list">
                                            <li>
                                                <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailTable')); ?></span> {{ reserve_no }}
                                            </li> 
                                            <li v-if="refund_kbn != '<?php echo e(\Config::get('constant.pay_method.card')); ?>' && refund_kbn != '<?php echo e(\Config::get('constant.pay_method.store')); ?>' && refund_kbn != '<?php echo e(\Config::get('constant.pay_method.free')); ?>'">
                                                <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_RefundAccount')); ?></span> {{ '('+bankCode+')'+bankName + '　　 <?php echo trans('sellManage.S_RefundBankBranch'); ?>: ' + branchName + '　　 <?php echo trans('sellManage.S_RefundAccountNumber'); ?>: ' + bankAccount }}  
                                            </li> 
                                            <li v-if="refund_kbn != '<?php echo e(\Config::get('constant.pay_method.store')); ?>'">
                                                <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_RefundAmount')); ?></span> <span class="__comma">{{ refundPaymentDisplay }}</span>
                                            </li>   
                                            <li>
                                                <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventTitle')); ?></span> {{ perfomanceTitle }}
                                            </li>
                                            <li>
                                                <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventOpenDate')); ?></span> {{ openDate }} - <?php echo e($event['openTime']); ?>

                                            </li>
                                            <li v-for="seatData in orderSeatData">
                                                <span class="badge bg-gray-light"><?php echo e(trans('sellManage.S_EventDetailSeatName')); ?>/<?php echo e(trans('sellManage.S_EventDetailTicketName')); ?></span> {{ seatData['seatTitle'] + '  ' + seatData['ticketTitle'] + '  ' +seatData['seatPosition'] }} 
                                            </li>
                                        </ul>      
                                    </div>
                                </div>
                    ...
                    <!--訂單金額修改-->  
                        <template  v-if="dialogType == 'reviseAmount'  && step != '-2'">   
                                ...
                                <div class="row form-horizontal" v-show="step == '1'">
                                    <div class="col-md-12">
                                        <h4 class="">
                                            <i class="fas fa-check-double"></i>
                                            <!-- 信用卡請使用  您選擇取消訂單 1911-100031-70，請確認欲退款的信用卡資訊：-->
                                            <?php echo trans('sellManage.S_ReviseAmountNotice11', ['reserve_no' => '{{ orderData["reserve_no"] }}']); ?>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="table-responsive">
                                                    <table id="" class="table table-striped table-white">
                                                        <thead>
                                                            <tr>
                                                                <th width="10%"><?php echo e(trans('sellManage.S_EventDetailSeatName')); ?></th>
                                                                <th width="15%"><?php echo e(trans('sellManage.S_EventDetailTicketName')); ?></th>
                                                                <th width="15%"><?php echo e(trans('sellManage.S_EventDetailSeatPosition')); ?></th>
                                                                <!-- 金額＆數字置右 -->
                                                                <th class="text-right"><?php echo e(trans('sellManage.S_ReviseAmountNotice5')); ?></th>
                                                                <th class="text-right"><?php echo e(trans('sellManage.S_ReviseAmountNotice15')); ?></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <th colspan="5">
                                                                <div class="total-box-non w-75">
                                                                    <table class="table table-gray">
                                                                        <tr>
                                                                            <th><?php echo e(trans('sellManage.S_ReviseAmountNotice16')); ?></th>
                                                                        ...
                                                                        <tr class="total-foot">
                                                                            <th><?php echo e(trans('sellManage.S_ReviseAmountNotice17')); ?></th>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">
                                                        <b>［ 必須 ］</b>
                                                        <?php echo e(trans('sellManage.S_ReviseAmountNotice7')); ?>
                            ...
                            <!-- form  step 2 資料詳細-->
                                <div class="row form-horizontal" v-show="step == 2">
                                    <div class="col-md-12">
                                        <h4 class="text-red" v-show="process == 'revise'" ><i class="fas fa-exclamation-triangle"></i>  <?php echo e(trans('sellManage.S_ReviseAmountNotice13')); ?></h4>
                                        <h4 class="" v-show="process == 'Inf'">
                                            <i class="fas fa-check-double"></i>
                                            <?php echo trans('sellManage.S_ReviseAmountNotice14', ['reserve_no' => '{{ orderData["revise_amount"]["data"]["created_at"] }}', 'update_account' => '{{ orderData["revise_amount"]["data"]["update_account"] }}']); ?>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="row">
                                                        <div class="min-25 col-md-3 col-sm-6 col-xs-12">
                                                            <div class="rate-box">
                                                                <div class="rate-box-content"><span class="rate-box-text"><?php echo e(trans('sellManage.S_ReviseAmountNotice1')); ?></span>
                                                        ...
                                                        <div class="min-25 col-md-3 col-sm-6 col-xs-12">
                                                            <div class="rate-box">
                                                                <div class="rate-box-content"><span class="rate-box-text"><?php echo e(trans('sellManage.S_ReviseAmountNotice2')); ?></span>
                                                        ...
                                                        <div class="min-25 col-md-3 col-sm-6 col-xs-12">
                                                            <div class="rate-box">
                                                                <div class="rate-box-content"><span class="rate-box-text"><?php echo e(trans('sellManage.S_ReviseAmountNotice3')); ?></span>
                                                        ...
                                                        <div class="min-25 col-md-3 col-sm-6 col-xs-12">
                                                            <div class="rate-box">
                                                                <div class="rate-box-content"><span class="rate-box-text"><?php echo e(trans('sellManage.S_ReviseAmountNotice4')); ?></span>
                                                            ...
                                                            <table id="" class="table table-striped table-white">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <!-- 金額＆數字置右 -->
                                                                        <th class="text-right"><?php echo e(trans('sellManage.S_ReviseAmountNotice5')); ?></th>
                                                                        <th class="text-right pr-20 "><?php echo e(trans('sellManage.S_ReviseAmountNotice15')); ?></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr v-for='seat in reviseSeatPrice'>
                    ...
                    <!--出票-->
                        <template v-if="dialogType == 'draw'">
                            ...
                            <button class="btn btn-danger pull-right" v-show="step == '3' && !isInsert" v-on:click="sendSeatInf('insert')">
                                <?php echo e(trans('sellManage.S_TicketingConfirm')); ?>
                            ...
                            <button class="btn btn-danger pull-right" v-show="step == '3' && isInsert  && !performance_disp_status" v-on:click="sendSeatInf('resend')">
                                <?php echo e(trans('sellManage.S_TicketingResend')); ?>
                    ...
                    <!--訂單金額修改-->
                        <template v-if="dialogType == 'reviseAmount'">   
                            ...
                            <button class="btn btn-danger pull-right" v-show="step == '2' && process == 'revise'"  v-on:click="sendReviseAmountInf()">
                                <?php echo e(trans('sellManage.S_ReviseAmountNotice18')); ?>
...
<script>
    const SchKbn = "<?php echo e($event['sch_kbn']); ?>"
    ...
    //銀行code資料
    const bankCode = <?php echo (\App::getLocale() == "ja" )?json_encode(\Config::get('bankcode.jp')):json_encode(\Config::get('bankcode.tw')); ?>
    ...
    var orderDetail = new Vue({
        ...
        data:{
           bankinf : bankCode,
           perfomanceTitle : "<?php echo e($event['perfomanceTitle']); ?>",
           performance_disp_status : false,
           openDate : "<?php echo e($event['openDate']); ?>",
           orderData : <?php echo json_encode($event['reservationData']); ?>,
           filtertData :  <?php echo json_encode($event['reservationData']); ?>,
           freeSeatInt: <?php echo json_encode($event['freeSeatInt']); ?>,
           keyword : '',
           orderRange : '',
           seatType : 'all',
           fTicketType : 'all',
           ...
           seatReserve : true,
           orderStatus : [],
           seatOption : <?php echo json_encode( $event['seatOption'] ); ?>,
           ticketOption : <?php echo json_encode( $event['ticketOption'] ); ?>,
           totalPie : <?php echo e($event['allPie']); ?>,
           totalPrice : <?php echo e($event['allTicketPrice']); ?>,
           totalCost : <?php echo e($event['allPriceCost']); ?>,
           receivedAmount : <?php echo e($event['received_amount_sum']); ?>,
           csv : '',
           showModal : false, 
           step: 3,
           isInsert: false,
           ...
           reviseSeatPrice:[],
           oriPriceSum:0,
           questionnaires : <?php echo json_encode($event['questionnaires']); ?>,
           popResult:[],
           seatSaleId: '',
           visitStatus: '',
        ...
        methods: {
            refundDisplay : function(){
                ...
                if(this.refund_kbn == '<?php echo e(\Config::get('constant.pay_method.free')); ?>'){
                    result = false
                }

                if(this.refund_kbn == '<?php echo e(\Config::get('constant.pay_method.store')); ?>'){
                    result = false
                }
                return result
            },
            ...
            getVisitFlg:function(visitText){
                let visitNo = 2
                switch(visitText) {
                    case "<?php echo e(trans('sellManage.S_EventDetailGot')); ?>":
                        visitNo = 1
                        break;
                    case "<?php echo e(trans('sellManage.S_EventDetailNotGet')); ?>":
                        visitNo = 2
                        break;
                }
                return visitNo
           ...
           /**
            ...
            setOrderVisit:function(data){
                ...
                if(data.visit_flg){
                    visitText = "<?php echo e(trans('sellManage.S_EventDetailGot')); ?>"
                }else{
                    visitText ="<?php echo e(trans('sellManage.S_EventDetailNotGet')); ?>"
                }
                ...
                if(odersVisit){
                    this.filtertData[orderIndex].visit_flg = "<?php echo e(trans('sellManage.S_EventDetailIncomplete')); ?>"
                }else{
            ...
            openReviseAmountStep2:function(){
                ...
                this.reviseSeatPrice.forEach(function(seat){
                    ...
                    if(!reNum.test(seatPrice)){
                        ...
                        seat.warnNotice += '<?php echo e(trans('sellManage.S_ReviseAmountNotice19')); ?>'
                    }

                    if(seatPrice <= 0){
                        checkResult     = false
                        seat.warnStatuc = true 
                        seat.warnNotice += ' <?php echo e(trans('sellManage.S_ReviseAmountNotice20')); ?>'
                    }

                    if(seatPrice > oriPrice){
                        checkResult     = false
                        seat.warnStatuc = true 
                        seat.warnNotice += ' <?php echo e(trans('sellManage.S_ReviseAmountNotice21')); ?>'
                    }
                });

                if(this.reviseMemo.length <= 0){
                    this.errorWarm   = '<?php echo e(trans('sellManage.S_ReviseAmountNotice22')); ?>'
            ...
            refundDataCheck: function(){ 
                ...
                try {
                    if(this.refundPayment  == "" && this.refund_kbn != '<?php echo e(\Config::get('constant.pay_method.free')); ?>'){
                    ...
                    if(this.refund_kbn != '<?php echo e(\Config::get('constant.pay_method.card')); ?>' && this.refund_kbn != '<?php echo e(\Config::get('constant.pay_method.store')); ?>' && this.refund_kbn != '<?php echo e(\Config::get('constant.pay_method.free')); ?>'){
                        if(this.bankCode == ""){
            ...
            setPaymentTotal : function(){
                ...
                if(filtertData['revise_amount']['reviseStatus']){
                    ...
                    if(filtertData['pay_method'] === 2 && filtertData['pickup_method'] === 3)
                        ...
                        (filtertData['pay_method'] == 3 && filtertData['pickup_method'] == '<?php echo e(\Config::get('constant.pickup_method.store')); ?>') ||
                        (filtertData['pay_method'] == 3 && filtertData['pickup_method'] == '<?php echo e(\Config::get('constant.pickup_method.resuq')); ?>') ||
                        (filtertData['pay_method'] == 3 && filtertData['pickup_method'] == '<?php echo e(\Config::get('constant.pickup_method.no_ticketing')); ?>') 
                    ){
                        //seven/seven
                        this.refundPayment  = parseInt(filtertData['allCost'])//予約取消金額
                        this.refundTextDisplay = false
                ...
                if(step == 3){
                    ...
                    switch(data.orderInf.pickup_method){
                        case 3:
                            ...
                            this.pickupMethodTitle  = '<?php echo e(trans('sellManage.S_EventDetailConvenience')); ?>'
                            break
                        case 9:
                            this.pickupMethod       = 'MOBAPASS'
                            this.pickupMethodTitle  = '<?php echo e(trans('sellManage.S_EventDetailPickup_ET')); ?>'
                            break
                        case 31:
                            this.pickupMethod       = 'ibon'
                            this.pickupMethodTitle  = '<?php echo e(trans('sellManage.S_EventDetailIbon')); ?>'
                            break
                        case 91:
                            this.pickupMethod       = 'QRPASS'
                            this.pickupMethodTitle  = '<?php echo e(trans('sellManage.S_EventDetailQrpass')); ?>'
                            break
                        case 8:
                            this.pickupMethod       = 'resuq'
                            this.pickupMethodTitle  = '<?php echo e(trans('sellManage.S_EventDetailResuQ')); ?>'
                            break
                        default:
                            this.pickupMethod       = '-'
        ...
        mounted(){
            this.performance_disp_status =  ["8", "7", "-1", "-99"].includes("<?php echo e($event['performance_disp_status']); ?>")
            ...
            <?php if(count($errors) > 0): ?> 
                this.showModal  = true
                this.step       = -2
                this.resultMsn  = '<?php echo e($errors->first()); ?>'
            <?php endif; ?>

            <?php if($event['insert_draw_result']): ?>
                this.showModal  = true
                this.step       = -2
                this.resultMsn  = "<?php echo e($event['insert_draw_msn']); ?>"
            <?php endif; ?>

            <?php if($event['resend_draw_result']): ?>
                this.showModal  = true
                this.step       = -2
            ...
            <?php if($event['cancel_order_result']): ?>
                this.showModal  = true
                this.resultMsn  = "<?php echo e($event['cancel_order_msn']); ?>"
                this.dialogType = 'orderCancel'
                
                let cancelStatus = "<?php echo e($event['cancel_order_status']); ?>"
            ...
            <?php if($event['revise_amount_result']): ?>
                this.showModal  = true
                this.step       = -2
                this.resultMsn  = "<?php echo e($event['revise_amount_msn']); ?>"
                this.dialogType = 'reviseAmount'
            <?php endif; ?>
           
            <?php if($event['filterJson']): ?>
                this.filterJson = '<?php echo addslashes($event['filterJson']); ?>'
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\GettiiLite (9)New\resources\views/frontend/sell/detail.blade.php ENDPATH**/ ?>