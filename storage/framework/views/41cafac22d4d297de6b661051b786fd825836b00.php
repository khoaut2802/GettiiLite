        ...
        <div class="form-horizontal">
                ...
                <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="box no-border"> 
                                <div class="box-header with-border-non">
                                    <h3 class="box-title"><?php echo e(trans('events.S_eventDescriptionTitle')); ?>

                                    <div class="tip"><span data-tooltip="<?php echo e(trans('events.S_eventImageNotice')); ?>"><i class="fas fa-info fa-1x fa__thead"></i></span></div>
                                    </h3>
                                            ...
                                            <div class="form-group-flex">
                                                <div class="form-checkbox">
                                                    <label class="control control--radio">
                                                        <input type="radio" name="contentType" v-model="contentType" value="image" :disabled="statucControl[0].top_content_type" data-max-file-size="2M" data-allowed-file-extensions='["png", "jpeg", "jpg"]' ><?php echo e(trans('events.S_image')); ?>
                                                ...
                                                <div class="form-checkbox">
                                                    <label class="control control--radio">
                                                        <input type="radio" name="contentType" v-model="contentType" value="vidio" :disabled="statucControl[0].top_content_type" data-max-file-size="2M" data-allowed-file-extensions='["png", "jpeg", "jpg"]' ><?php echo e(trans('events.S_Video')); ?>
                                ...
                                <div class="box-body box-510 pt-x">
                                    <div class="col-md-12">
                                        <small class="subtitle"><?php echo e(trans('events.S_eventDescriptionTitleDesc')); ?></small><!--  STS 2021/05/28 -->
                                        <!-- 圖片區 -->
                                            ...
                                            <div class="form-group mtb-2" v-show="(contentType == 'vidio')?true:false">
                                                <label class="col-md-3 control-label"><?php echo e(trans('events.S_VideoContent')); ?><b><?php echo e(trans('events.S_RequiredMark')); ?></b></label>
                                                <div class="col-md-9">
                                                    <input name='top-content-url' type="text" class="form-control" v-validate="'max:250'"  maxlength="255" v-model="contentVidioUrl" :disabled="statucControl[0].top_content_url" placeholder="<?php echo e(trans('events.S_VideoContentPlaceholder')); ?>">
                                            ...
                                            <div class="form-group mtb-2">
                                                <label class="col-md-3 control-label"><?php echo e(trans('events.S_eventTopCommentTitle')); ?></label>
                                                <div class="col-md-9">
                                                    <input name='top-content-comment' v-validate="'max:255'"  maxlength="250" type="" class="form-control" v-model="contentComment" :disabled="statucControl[0].top_content_comment" placeholder="<?php echo e(trans('events.S_eventTopCommentPlaceholder')); ?>">
                                                    <span v-show="errors.has('top-content-comment')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('top-content-comment') }}</span>
                                                     <p><small class="subtitle"><?php echo e(trans('events.S_eventTopCommentDesc')); ?></small></p><!--  STS 2021/05/28 -->
                                                </div>
                                            </div>
                    ...
                    <!-- box1 統一樣式右邊單欄 + 列表圖片區 -->
                        <div class="col-md-4">
                            <div class="box no-border">
                                <div class="box-header with-border-non">
                                    <h3 class="box-title"><?php echo e(trans('events.S_basicInfoTitle')); ?>
                                ...
                                <div class="box-body box-510 pt-x">
                                    <div class="">
                                        <div class="col-md-12">
                                            <small class="subtitle"><?php echo e(trans('events.S_basicInfoTitleDesc')); ?></small><!--  STS 2021/05/28 -->
            ...
            <!-- box1 統一樣式 + 基本情報設定 -->
                <div class="box no-border">
                    <div class="box-header with-border-non form-group-flex">
                        <h3 class="box-title"><?php echo e(trans('events.S_basicInfoTitle')); ?></h3>
                        <!-- 英文欄位 switch -->
                            <div class="form-checkbox">
                                <div class="checkbox checbox-switch switch-info">
                                    <label>
                                        ...
                                        <span></span><?php echo e(trans('events.S_eventDispEnglish')); ?>
                        ...
                        <div class="form-horizontal">
                            <!---->
                                <div class="form-group">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventcodeTitle')); ?><b><?php echo e(trans('events.S_RequiredMark')); ?></b></label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control"  name="<?php echo e(trans('events.S_eventcodeTitle')); ?>" v-model="eventId" maxlength="10" v-validate="'required|alpha_num|min:4|max:10'" :disabled="statucControl[0].performance_code" placeholder="<?php echo e(trans('events.S_eventcodePlaceholder')); ?>">
                                        <span v-show="errors.has('<?php echo e(trans('events.S_eventcodeTitle')); ?>')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('<?php echo trans('events.S_eventcodeTitle'); ?>') }}</span>
                                    </div>
                                </div>
                            <!---->
                                <div class="form-group mtb-1">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventMaintitleTitle')); ?><b><?php echo e(trans('events.S_RequiredMark')); ?></b></label>
                                    <div class="col-md-10">
                                        <input id="eventTitle" type="text"  v-validate="'max:255|sej_format:21'" maxlength="250" name="event-title" class="form-control" v-model="eventTitle" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_eventMaintitlePlaceholder')); ?>">
                                        <span v-on:change="setting()" dusk="eventTitleValidate" v-show="errors.has('event-title')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('event-title') }}</span>
                                         ...
                                         <span class="help is-danger" v-show="eventTitle && eventTitle != eventTitle.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                    </div>
                                </div>
                                <div class="form-group mtb-1" v-if="enInformation.status.performanceStatus">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventMaintitleTitle')); ?>(英)</label>
                                    <div class="col-md-10">
                                        ...
                                        <span v-show="errors.has('event-title-en')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('event-title-en') }}</span>
 										<!-- STS 2021/07/26 task 38 -->
                                         <span class="help is-danger" v-show="enInformation.data.performanceName && enInformation.data.performanceName != enInformation.data.performanceName.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                    </div>
                                </div>
                            <!---->
                                <div class="form-group mtb-1">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventSubtitleTitle')); ?></label>
                                    <div class="col-md-10">
                                        <input id="eventSubTitle" type="text" v-validate="'max:255|sej_format:21'" maxlength="250" name="event-sub-title" class="form-control" v-model="eventSubTitle" :disabled="statucControl[0].performance_name_sub" placeholder="<?php echo e(trans('events.S_eventSubtitlePlaceholder')); ?>">
                                        <span dusk="eventSubTitleValidate" v-show="errors.has('event-sub-title')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('event-sub-title') }}</span>
 										<!-- STS 2021/07/26 task 38 -->
                                    	<span class="help is-danger" v-show="eventSubTitle && eventSubTitle != eventSubTitle.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                    </div>
                                </div>
                            <div class="form-group mtb-1" v-show="enInformation.status.performanceStatus">
                                <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventSubtitleTitle')); ?>(英)</label>
                                <div class="col-md-10">
									...
									<!-- STS 2021/07/26 task 38 -->
                                    <span class="help is-danger" v-show="enInformation.data.performanceNameSub && enInformation.data.performanceNameSub != enInformation.data.performanceNameSub.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                </div>
                            </div>
                            <!--//提示訊息 -->
                            ...
                            <!-- 活動公開日 -->
                                <div class="form-group form-group-flex">
                                    <label class="col-sm-2 control-label"><?php echo e(trans('events.S_eventPublishDateTitle')); ?></label>
                                    <div class="col-sm-10">
                            ...
                            <!-- 活動期間 -->
                                <div class="form-group form-group-flex">
                                    <label class="col-sm-2 control-label"><?php echo e(trans('events.S_eventPeriodTitle')); ?></label>
                                    <!-- 20201201欄位調整 -->
                                    <div class="col-sm-5">
                            ...
                            <!--活動類型  0410新增調整-->
                                <div class="form-group">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventTypeTitle')); ?></label>
                                    <div class="col-md-10">
                                        <!-- 舞台劇 ｜ 劇場-->
                                        <a class="btn btn-app" :class="{ active: eventType == 300 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(300)">
                                           ...
                                           <i class="active-style"><img src="/assets/images/icon/i-stage.svg"></i>
                                            <?php echo e(trans('common.S_eventType_300')); ?>   
                                        </a>
                                        <!-- 運動賽事 -->
                                        <a class="btn btn-app" :class="{ active: eventType == 200 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(200)">
                                            ...
                                            <?php echo e(trans('common.S_eventType_200')); ?>   
                                        </a>
                                        <!--電影--> 
                                        <a class="btn btn-app" :class="{ active: eventType == 700 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(700)">
                                           ...
                                           <!-- <i class="fa fa-edit"></i>-->
                                            ...
                                            <?php echo e(trans('common.S_eventType_700')); ?>   
                                        </a>
                                        <!--活動 ｜ 展覽 ｜藝術-->
                                        <a class="btn btn-app" :class="{ active: eventType == 500 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(500)">
                                            ...
                                            <?php echo e(trans('common.S_eventType_500')); ?>   
                                        </a>
                                        <!--音樂演唱會-->
                                        <a class="btn btn-app" :class="{ active: eventType == 100 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(100)">
                                           ...
                                           <!-- <i class="fa fa-edit"></i>-->
                                            ...
                                            <?php echo e(trans('common.S_eventType_100')); ?>   
                                        </a>
                                        <!--休閒 ｜ 娛樂-->
                                        <a class="btn btn-app" :class="{ active: eventType == 600 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(600)">
                                            ...
                                            <?php echo e(trans('common.S_eventType_600')); ?>   
                                        </a>
                                        <!--古典 ｜ 歌劇-->
                                        <a class="btn btn-app" :class="{ active: eventType == 400 }"  v-bind:style="pointerEvents" v-on:click="eventTypeSelect(400)">
                                            ...
                                            <?php echo e(trans('common.S_eventType_400')); ?>   
                                        </a>
                                        <!--節慶祭典-->
                                        <a class="btn btn-app" :class="{ active: eventType == 1000 }" v-on:click="eventTypeSelect(1000)">
                                            ...
                                            <?php echo e(trans('common.S_eventType_1000')); ?>   
                                        </a>
                                        <!--其他-->
                                        <a class="btn btn-app" :class="{ active: eventType == 900 }" v-bind:style="pointerEvents" v-on:click="eventTypeSelect(900)">
                                            ...
                                            <?php echo e(trans('common.S_eventType_900')); ?>   
                                        </a>
                                    </div>
                                </div> 
                            <!--/.活動類型  0410新增調整-->
            ...
            <!--  box2 統一樣式 + 活動日期 20200818調整 -->
                <div class="box no-border">
                    <!-- Block 1 -->
                        <div class="box-header with-border-non form-group-flex">
                            <h3 class="box-title"><?php echo e(trans('events.S_eventDatetimeTitle')); ?></h3>
                        </div>
                        <!--//提示訊息 -->
                                    ...
                                    <div class="box-body">
                                            ...
                                            <div class="form-group form-group-flex">
                                                <div class="form-checkbox col-sm-1">
                                                    <label class="control control--checkbox pull-right mtb-1">
                                                        <input v-if="infOpenIsNull" type="checkbox" v-model="earlyBirdDateChecked" :disabled="!performance_end_dt || statucControl[0].reserve_dt"><?php echo e(trans('events.S_eventPresaleTitle')); ?>

                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                                <label class="col-sm-2 control-label text-left"><?php echo e(trans('events.S_eventSellDateTitle')); ?></label>
                                                <!-- 20201201欄位調整 -->
                                        ...
                                        <!--form4-->
                                            <div class="form-group form-group-flex">
                                                <div class="form-checkbox col-sm-1">
                                                    <label class="control control--checkbox pull-right mtb-1">
                                                        <input  v-if="infOpenIsNull" type="checkbox" v-model="normalDateChecked" :disabled="!performance_end_dt || statucControl[0].sell_dt"><?php echo e(trans('events.S_eventSaleTitle')); ?>
            ...
            <!--  box3 統一樣式 + 活動場館 -->
                <div class="box no-border">
                    <!-- Block 1 -->
                        <div class="box-header with-border-non form-group-flex">
                            <h3 class="box-title"><?php echo e(trans('events.S_eventHallInfoTitle')); ?></h3>
                            <!-- 英文欄位 switch -->
                                <div class="form-checkbox">
                                    <div class="checkbox checbox-switch switch-info">
                                        <label>
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                <div class="col-md-12">   
                                    <!--form1-->
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventHallNameTitle')); ?><b><?php echo e(trans('events.S_RequiredMark')); ?></b></label>
                                            <div class="col-md-10">
                                                <input id="placeTitle" v-validate="'max:80'" maxlength="80" name="place-name"  type="text" class="form-control" v-model="locationName" :disabled="hallDisable || statucControl[0].hall_name" placeholder="<?php echo e(trans('events.S_eventHallNamePlaceholder')); ?>">
                                    ...
                                    <!--form2-->
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventHallDisplayTitle')); ?><b><?php echo e(trans('events.S_RequiredMark')); ?></b></label>
                                            <div class="col-md-10">
                                                <input name="hall-name" type="" class="form-control" v-validate="'max:80'" maxlength="80" placeholder="<?php echo e(trans('events.S_eventHallDisplayPlaceholder')); ?>" v-model="hallName" :disabled="statucControl[0].hall_name_set">
                                                ...
                                                <!-- STS 2021/07/26 task 38 -->
                                                <span class="help is-danger" v-show="hallName && hallName != hallName.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                            </div>
                                        </div>
                                    <!--/.form2-->
                                    <!--form2 英文-->
                                        <div class="form-group" v-show="enInformation.status.hallStatus">
                                            <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventHallDisplayTitle')); ?>(英)</label>
                                            <div class="col-md-10">
                                                ...
                                                <!-- STS 2021/07/26 task 38 -->
                                                <span class="help is-danger" v-show="enInformation.data.hallDispName && enInformation.data.hallDispName != enInformation.data.hallDispName.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                            </div>
                                        </div>
                                    <!--/.form2-->
                                    <!--form3-->
                                        <div class="row city-selector-set-has-value">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label"><?php echo e(trans('events.S_eventHallLocationTitle')); ?></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label"><?php echo e(trans('events.S_eventHallSublocationTitle')); ?></label>
                                                    <div class="col-md-8">
                                    ...
                                    <!--form4-->
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventHallURLTitle')); ?></label>
                                            <div class="col-md-10">
                                                <input id="placeUrl" v-validate="'url:require_protocol|max:200'" maxlength="200" :disabled="hallDisable || statucControl[0].hall_url" name="place-url" type="text" class="form-control" v-model="localUrl" placeholder="<?php echo e(trans('events.S_eventHallURLPlaceholder')); ?>">
                                    ...
                                    <!--form5-->
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventHallNoteTitle')); ?></label>
                                            <div class="col-md-10">
                                                <input name='hall-disable' type="text" class="form-control" :disabled="hallDisable || statucControl[0].description" v-validate="'max:80'" maxlength="80" v-model="locationDescription" placeholder="<?php echo e(trans('events.S_eventHallNotePlaceholder')); ?>">
                    ...
                    <div class="box-footer text-right" v-show="!statucControl[0].hall_name">
                        <button type="button" class="btn waves-effect waves-light btn-angle btn-info-outline" v-on:click="clearHill()"><?php echo e(trans('events.S_eventClearHallBtn')); ?></button>
                        <button type="button" class="btn waves-effect waves-light btn-angle btn-info" v-on:click="openDialog()" data-toggle="modal" data-target="#user-select"><?php echo e(trans('events.S_eventHavingHallBtn')); ?></button>
                    </div>
                </div>
            <!--  /.box3 統一樣式 + 活動場館 -->
             ...
             <!--  box4 統一樣式 + 活動聯絡資訊 20200818調整 -->
                <div class="box no-border">
                    <!-- Block 1 -->
                        <div class="box-header with-border-non form-group-flex">
                            <h3 class="box-title"><?php echo e(trans('events.S_eventContactInfoTitle')); ?></h3>
                            <!-- 英文欄位 switch -->
                                    <div class="form-checkbox">
                                        <div class="checkbox checbox-switch switch-info">
                                            <label>
                    ...
                    <div class="form-horizontal">
                       <div class="box-body">
                                <div class="form-group">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventContactNameTitle')); ?><b><?php echo e(trans('events.S_RequiredMark')); ?></b></label> <!-- STS 2021/08/25 Task 47 -->
                                    <div class="col-md-10">
                                        <input id="customerInfTitle" type="text"  v-validate="'max:80'" maxlength="80"  name="title" class="form-control" v-model="eventContact" :disabled="statucControl[0].information_nm" placeholder="<?php echo e(trans('events.S_eventContactNamePlaceholder')); ?>">
                                        ...
                                        <!-- STS 2021/07/26 task 38 -->
                                        <span class="help is-danger" v-show="eventContact && eventContact != eventContact.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                    </div>
                                </div>
                                <div class="form-group" v-show="enInformation.status.informationStatus">
                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_eventContactNameTitle')); ?>(英)</label>
                                    <div class="col-md-10">
									    ...
									    <!-- STS 2021/07/26 task 38 -->
                                        <span class="help is-danger" v-show="enInformation.data.informationNm && enInformation.data.informationNm != enInformation.data.informationNm.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_basicerrorMsn')); ?></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventContactEmailTitle')); ?></label>
                                    <div class="col-md-10">
                                        <input name="email"  type="text" style="display:none">
                                        <input id="customerInfEmail" v-validate="'email|max:200'"  maxlength="200"  name="email"  type="text" class="form-control" v-model="eventContactMail" :disabled="statucControl[0].mail_address" placeholder="<?php echo e(trans('events.S_eventContactEmailPlaceholder')); ?>" >
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label"><?php echo e(trans('events.S_eventContactTelTitle')); ?></label>
                                    <div class="col-md-10">
                                        <input id="customerInfTel" v-validate="'tel_format|min:10|max:13'"  maxlength="13"  name="tel" type="tel" class="form-control" v-model="eventContactTel" :disabled="statucControl[0].information_tel" placeholder="<?php echo e(trans('events.S_eventContactTelPlaceholder')); ?>">
            ...
            <details>
                <summary>
                    <span class="summary-title"><?php echo e(trans('events.S_eventAdvanced')); ?></span>
                    <i class="summary-chevron-up"></i>
                </summary>
                <div class="summary-content">
                    <!--0602 非會員-->
                    <div class="box no-border no-radius">
                        <div class="box-header box-s4 with-border"><h3 class="box-title"><?php echo e(trans('events.S_nonMemberTitle')); ?></h3></div> 
                            <div class="form-horizontal">
                                <div class="box-body pad">
                                    <div class="form-checkbox">
                                        <div class="checkbox checbox-switch checbox-switch-non switch-info">
                                            <label><input type="checkbox" :disabled="statucControl[0].basis" v-model='sellAnyone'> <span></span><?php echo e(trans('events.S_nonMemberSwitch')); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!--  box5 統一樣式 + 活動介紹 -->
                        <div class="box no-border no-radius">
                            <div class="box-header box-s4 with-border">
                                <h3 class="box-title"><?php echo e(trans('events.S_eventIntroTitle')); ?></h3>
                            </div>
                            <!-- Form -->
                                <div class="form-horizontal">
                                    <div class="box-body pad" v-bind:style="pointerEvents">
                                        <form>
                                            ...
                                            ▶︎ <?php echo e(trans('events.S_inputLength')); ?> ： {{ wordCount['editor'].total }}  （<?php echo e(trans('events.S_limitLength')); ?> ： {{ wordCount['editor'].limit}}）<span class="editor-count-error" v-show='wordCount["editor"].errorStatus'> <i class="fas fa-exclamation-circle"></i> <?php echo e(trans('events.S_limitLengthOver')); ?> {{ this.wordCount['editor'].overTotal }}</span>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <!--<div class="box-footer">
                                <button id="preview"  type="button" class="btn waves-effect waves-light btn-angle btn-info"><?php echo e(trans('events.S_eventPreviewBtn')); ?></button>
                            </div>-->
                            <!---/.box-footer --->
                        </div>
                        ...
                        <div class="box no-border no-radius no-border-bottom">
                            <div class="box-header with-border box-s4">
                                <h3 class="box-title">
                                    <?php echo e(trans('events.S_FreeQuestionTitle')); ?>
                                    ...
                                    <div class="box box-solid"> 
                                        ...
                                        <div class="form-horizontal">
                                            <div class="box-body" v-bind:style="pointerEvents">
                                                <!-- ja -->
                                                <div class="form-group">
                                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionCapt')); ?></label>
                                                    <div class="col-md-10">
                                                        <input :id="'questionTitle-ja-' + qIndex" type="text" v-validate="'max:255'" maxlength="255" name="question-title" class="form-control" v-model="questionnaire.langs.ja.title" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_FreeQuestionCaptPlaceholder')); ?>">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionDesc')); ?></label>
                                                    <div class="col-md-10">
                                                        <textarea class="form-control" rows="4" v-validate="'max:2000'" style="resize:none" maxlength="2000" name="question-desc" v-model='questionnaire.langs.ja.text' :disabled="statucControl[0].basis" placeholder="<?php echo e(trans('events.S_FreeQuestionDescPlaceholder')); ?>"></textarea>
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionAns')); ?></label>
                                                    <div class="col-md-10">
                                                        <div class="row">
                                                            <div class="col-md-2 control-label-checkbox">
                                                                <label class="control control--checkbox" >
                                                                    <input type="checkbox" v-model="questionnaire.required" :disabled="statucControl[0].basis"><?php echo e(trans('events.S_FreeQuestionRequired')); ?>

                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <input :id="'answerPlaceholder-ja-' + qIndex" type="text" v-validate="'max:255'" maxlength="255" name="answer-placeholder" class="form-control" v-model="questionnaire.langs.ja.placeholder" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_FreeQuestionAnsPlaceholder')); ?>">
                                                ...
                                                <div v-show="questionnaire.langs.en.selected">
                                                    <div class="form-group">
                                                        <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionCapt')); ?>(英)</label>
                                                        <div class="col-md-10">
                                                            <input :id="'questionTitle-en-' + qIndex" type="text" v-validate="'max:255'" maxlength="255" name="question-title" class="form-control" v-model="questionnaire.langs.en.title" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_FreeQuestionCaptPlaceholder')); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionDesc')); ?>(英)</label>
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" rows="4" v-validate="'max:2000'" style="resize:none" maxlength="2000" name="question-desc" v-model='questionnaire.langs.en.text' :disabled="statucControl[0].basis" placeholder="<?php echo e(trans('events.S_FreeQuestionDescPlaceholder')); ?>"></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionAns')); ?>(英)</label>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input :id="'answerPlaceholder-en-' + qIndex" type="text" v-validate="'max:255'" maxlength="255" name="answer-placeholder" class="form-control" v-model="questionnaire.langs.en.placeholder" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_FreeQuestionAnsPlaceholder')); ?>">
                                                ...
                                                <div v-show="questionnaire.langs.zh_tw.selected">
                                                    <div class="form-group">
                                                        <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionCapt')); ?>(中)</label>
                                                        <div class="col-md-10">
                                                            <input :id="'questionTitle-zh-tw-' + qIndex" type="text" v-validate="'max:255'" maxlength="255" name="question-title" class="form-control" v-model="questionnaire.langs.zh_tw.title" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_FreeQuestionCaptPlaceholder')); ?>">
                                                            <span v-on:change="setting()" dusk="" v-show="errors.has('question-title')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('question-title') }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionDesc')); ?>(中)</label>
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" rows="4" v-validate="'max:2000'" style="resize:none" maxlength="2000" name="question-desc" v-model='questionnaire.langs.zh_tw.text' :disabled="statucControl[0].basis" placeholder="<?php echo e(trans('events.S_FreeQuestionDescPlaceholder')); ?>"></textarea>
                                                            <span v-on:change="setting()" dusk="" v-show="errors.has('question-desc')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('question-desc') }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-md-2 control-label"><?php echo e(trans('events.S_FreeQuestionAns')); ?>(中)</label>
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="col-md-2 control-label-checkbox">
                                                                    <label class="control control--checkbox" >
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input :id="'answerPlaceholder-zh-tw-' + qIndex" type="text" v-validate="'max:255'" maxlength="255" name="answer-placeholder" class="form-control" v-model="questionnaire.langs.zh_tw.placeholder" :disabled="statucControl[0].tenporary_info" placeholder="<?php echo e(trans('events.S_FreeQuestionAnsPlaceholder')); ?>">
                                                                    <span v-on:change="setting()" dusk="" v-show="errors.has('answer-placeholder')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> {{ errors.first('answer-placeholder') }}</span>
                                                                </div>
                                                            </div>   
                                                        </div>
                        ...
                        <div class="btn-group mb-5">
                            <button  v-on:click="addQuestionnaire"class="btn btn-block waves-effect waves-light btn-add":disabled=" statucControl[0].basis || limitQuestionnaire == false "readonly><?php echo e(trans('events.S_eventAddQuestionnaire')); ?></button>
                    ...
                    <!--  /.box5 統一樣式 + 活動介紹 -->
                          ...
                          <div class="box no-border no-radius">
                            <div class="box-header box-s4 with-border">
                              <h3 class="box-title"><?php echo e(trans('events.S_eventAutoTranslate')); ?></h3>
                            </div>
                            <!-- Form -->
                            <div class="form-horizontal">
                              <div class="box-body pad" v-bind:style="pointerEvents">
                                <div class="form-checkbox">
                                  <div class="checkbox checbox-switch checbox-switch-non switch-info"><label><input type="checkbox"  v-model="autoTransChecked" :disabled="statucControl[0].basis"> <span></span><?php echo e(trans('events.S_eventAutoTranslateCheck')); ?>

                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-12 form-checkbox-groupbox">
                                  <div class="form-checkbox-title"><?php echo e(trans('events.S_eventSlectLanguage')); ?></div>
                                    <div class="col-md-2 form-checkbox">
                                      <label class="control control--checkbox" >
                                        <input type="checkbox" v-model="autoTransZhtw" :disabled="statucControl[0].basis"><?php echo e(trans('events.S_eventTranslateZhtw')); ?>
                                    ...
                                    <div class="col-md-2 form-checkbox">
                                      <label class="control control--checkbox" >
                                        <input type="checkbox" v-model="autoTransEng" :disabled="statucControl[0].basis"><?php echo e(trans('events.S_eventTranslateEng')); ?>
                    ...
                    <!--Title-->
                        <div class="box no-border no-radius no-border-bottom">
                            <div class="box-header with-border box-s4">
                                <h3 class="box-title">
                                    <?php echo e(trans('events.S_eventArticle')); ?>

                                    <div class="tip"><span data-tooltip="<?php echo e(trans('events.S_eventArticleNotice')); ?>"><i class="fas fa-info fa-1x fa__thead"></i></span></div>
                                </h3>
                            </div>
                        </div>
                    <!--/.Title--> 
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <!--圖片與影片-->
                                                                <div class="form-group-flex mb-4">
                                                                    ...
                                                                    <label class="control control--radio" v-bind:for="'content_type' + index + '-1'">
                                                                        <input v-model="article.type" v-bind:name="'type' + index" v-bind:id="'content_type' + index + '-1'" type="radio" value="1" :disabled="statucControl[0].top_content_type"><?php echo e(trans('events.S_image')); ?>
                                                                    ...
                                                                    <label class="control control--radio" v-bind:for="'content_type' + index + '-2'">
                                                                        <input v-model="article.type" v-bind:name="'type' + index" v-bind:id="'content_type' + index + '-2'" type="radio" value="2" :disabled="statucControl[0].top_content_type"><?php echo e(trans('events.S_Video')); ?>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group mtb-2" v-show="(article.type == '2')?true:false">
                                                                    <label class="col-md-2 control-label"><?php echo e(trans('events.S_VideoContent')); ?></label>
                                                                    <div class="col-md-10">
                                                                        <input type="text"  maxlength="255" class="form-control" v-model="article.video_url" :disabled="statucControl[0].top_content_url" placeholder="<?php echo e(trans('events.S_VideoContentPlaceholder')); ?>">
                                                                    </div>
                                                                </div>
                                                                <!--/.form5-->
                                                            </div>
                    ...
                    <!-- 新增活動按鈕 置底-->
                        <div class="btn-group mb-5">
                            <button  v-on:click="addContent" class="btn btn-block waves-effect waves-light btn-add" :disabled="statucControl[0].basis"><?php echo e(trans('events.S_eventAddArticle')); ?></button>
                        </div>
                    <!--/.新增活動按鈕 置底-->
                    <!-- /.1210 新增  -->
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><?php echo e(trans('events.S_eventHavingHallTitle')); ?></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row form-horizontal">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group"><label class="col-md-2 control-label"><?php echo e(trans('events.S_eventHallNameTitle')); ?></label>
                                        <div class="col-md-10">
                                ...
                                <div class="col-md-12 text-right">
                                    <button v-on:click="clearHillSreach()" type="button" class="btn btn-inverse btn-mm"><?php echo e(trans('events.S_resetBtn')); ?></button>
                                    <button v-on:click="hallList()" id="" class="btn btn-info btn-mm ml-15x"><?php echo e(trans('events.S_SearchBtn')); ?></button>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <hr>
                                        ...
                                        <div class="result-list-content">
                                            <div class="result-list-content_text">
                                                ...
                                                <div class="col-md-12 result-list-title">
                                                    <div class="col-md-5"><?php echo e(trans('events.S_eventHallNameTitle')); ?></div>
                                                    <div class="col-md-5"><?php echo e(trans('events.S_eventHallNoteTitle')); ?></div>
                                                    <div class="col-md-2"><?php echo e(trans('events.S_eventHallLocationTitle')); ?></div>
                                                </div>
                                                <!---->
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" v-on:click="closeDialog()"><?php echo e(trans('events.S_cancelBtn')); ?></button>
                            <button id="dialogUpBtn" class="btn btn-primary" v-on:click="confirmDialog()"><?php echo e(trans('events.S_selectBtn')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var articles = <?php echo old('article') ? old('article') : ($eventData['article'] ? $eventData['article'] : "[{text: '', type: 1, 'subContent':true, 'image_url': null, 'video_url':null}]"); ?>;
    var articlesDisp;
    ...
    function setArticleTextArea(index) {
        ...
        .create( document.querySelector( '#editor'  + index),{
            ...
            ckfinder: {
                uploadUrl: "/upload_image?_token=<?php echo e(csrf_token()); ?>&location=<?php echo $eventData['evenId']; ?>"
            }
        } )
        .then(editor => {
    ...
    var basisSetting = new Vue({
        ...
        methods: {
           ...
           settingArticleImage:function(){        
                  $.getScript("<?php echo e(asset('js/dropify.min.js')); ?>", function(){
                    //STS 2021/07/28 Task 41
            ...
            getError:function(){
                if(
                   ...
                   this.errors.has('<?php echo e(trans("events.S_eventcodeTitle")); ?>') ||
            ...
            settingCheack:function (item) {
                ...
                if(this.errors.has('eventid') || this.errors.has('<?php echo e(trans("events.S_eventcodeTitle")); ?>')){
                    this.addButtonErrorStatus = true;
                    errorMsnCheack.addBtnCheack();
                }else{
                    this.addButtonErrorStatus = false;
            ...
            saveLocalStock:function(){
                ...
                { 
                  ...
                  if ( image_url != '' && image_url.indexOf('<?php echo e(url('/')); ?>') == -1) {
                    image_url = '<?php echo e(url('/')); ?>' + image_url;
                  }
            ...
            dateCheackRule:function(type){
                ...
                if(openDate != null &&  performanceS != null && openDate > performanceS){
                    result.status   = false
                    result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_1')); ?>"
                    result.type = 'basis'
                    return result
                }
                if(performanceS){
                    if(performanceE == null) {
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_2-6')); ?>"
                        result.type = 'basis'
                        return result
                    }
                    if(performanceS != null && performanceE != null && performanceS > performanceE){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_2-7')); ?>"
                        result.type = 'basis'
                        return result
                    }
                }
                if(this.dateEnd.setFlg == 'EndDate'){
                    if(isNaN(dateEnd)) {
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_4-1')); ?>"
                        result.type = 'basis'
                        return result
                    }
                    if(dateEnd < openDate) {
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_4-3')); ?>"
                        result.type = 'basis'
                        return result
                    }
                    if(dateEnd < performanceE) {
                        ...
                        {
                          result.status   = false
                          result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_4-2')); ?>"
                          result.type = 'basis'
                          return result
                        }
                    }
                ...
                if(this.earlyBirdDateChecked) {
                    if(isNaN(earlyBirdDateS) || isNaN(earlyBirdDateE)){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_2-1')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(earlyBirdDateS == null){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-8')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(earlyBirdDateE == null){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-9')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(earlyBirdDateS != null && earlyBirdDateE != null && (Date.parse(this.earlyBirdDateStart)).valueOf() > (Date.parse(this.earlyBirdDateEnd)).valueOf()){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-10')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(performanceS < earlyBirdDateS){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_2-2')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(earlyBirdDateE > performanceE ){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_2-3')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(openDate != null && earlyBirdDateS != null && openDate > (Date.parse(this.earlyBirdDateStart)).valueOf()){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_2-4')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                ...
                if(this.normalDateChecked) {
                    if(isNaN(normalDateS) || isNaN(normalDateE) ) {                    
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-1')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(normalDateS == null){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-11')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(normalDateE == null){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-12')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(normalDateS != null && normalDateE != null && (Date.parse(this.normalDateStart)).valueOf() > (Date.parse(this.normalDateEnd)).valueOf()){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-13')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(openDate != null && normalDateS != null && openDate > (Date.parse(this.normalDateStart)).valueOf() ){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-2')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(normalDateE != null &&  performanceE != null && normalDateE > performanceE){
                        result.status   = false
                        result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-3')); ?>"
                        result.type = 'advanced'
                        return result
                    }
                    if(!this.earlyBirdDateChecked) {
                      ...
                      if(normalDateS > performanceS){
                          result.status   = false
                          result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-5')); ?>"
                          result.type = 'advanced'
                          return result
                      }
                    }
                    if(this.earlyBirdDateChecked) {
                        if(normalDateE != null && earlyBirdDateS != null && normalDateE <= earlyBirdDateS){
                            result.status   = false
                            result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-4')); ?>"
                            result.type = 'advanced'
                            return result
                        }
                        ...
                        //    result.status   = false
                        //    result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-6')); ?>"
                        //    result.type = 'advanced'
                        //    return result                    
                        //}
                        ...
                        if(earlyBirdDateS == normalDateS && earlyBirdDateE > normalDateE && earlyBirdDateStartDate != performanceStartDate){
                            ...
                            //発売開始日と開催初日が同じというケースは許可
                            result.status   = false
                            result.msn      = "<?php echo e(trans('events.S_verMsg_Date') . trans('events.S_verMsg_Date_3-7')); ?>"
                            result.type = 'advanced'
                            return result                    
                        }
                    }
        ...
        mounted(){  
            sessionStorage.setItem('hall', '<?php echo addslashes($eventData["hallData"]); ?>')
            ...
            this.perfomanceStatus = '<?php echo $eventData["status"]; ?>'

            <?php if( $eventData["status"] === 'edit' || $eventData["status"] === 'new2' || count($errors) > 0): ?>  
                sessionStorage.setItem('basisData','<?php echo addslashes($eventData["basisData"]); ?>')                
            ...
            <?php else: ?>
                ...
                this.eventId = '<?php echo $eventData['evenId']; ?>'
                this.imageLocation = '<?php echo $eventData['evenId']; ?>'
                ...
                //this.eventContact   =   '<?php echo $eventData["contact_inf"]["contact_person"]; ?>'
                //this.eventContactMail   =   '<?php echo $eventData["contact_inf"]["mail_address"]; ?>'
                //this.eventContactTel    =   '<?php echo $eventData["contact_inf"]["tel_num"]; ?>'

                this.questionnaires = <?php echo isset($eventData['questionnaires']) ? json_encode($eventData['questionnaires']) : json_encode([]); ?>,
...
<?php /**PATH /home/vagrant/code/gettiilite/resources/views/frontend/event/editLayout/basic.blade.php ENDPATH**/ ?>