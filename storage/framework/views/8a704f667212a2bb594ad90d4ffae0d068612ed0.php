<div id="seatSetting"> 
    <div class="row form-horizontal">
        ...
        <div class="callout callout-info mb-5">
            <h4></h4>
            <?php echo trans('events.S_seatMainDesc'); ?>

            <p class="pl-20"><small><?php echo trans('events.S_seatMainMemo'); ?></small></p>
        </div>
        <!-- /.callout info -->
            <!-- BOX 1 -->
            <div class="box no-border"  v-show="!statucControl[0].excel">
                <div class="box-header with-border-non" data-widget="collapse"> 
                    <h3 class="box-title">{{ (basisSetting.hallName)?basisSetting.hallName:basisSetting.locationName }} - <?php echo e(trans('events.S_VenueSetting')); ?></h3>
                ...
                <div class="box-header with-border-non" data-widget="collapse">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="col-sm-4 control-label text-black"><?php echo e(trans('events.S_SeatTotal')); ?></label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="col-sm-5 control-label text-black"><?php echo e(trans('events.S_SeatUnSet')); ?></label>
                            <div class="col-sm-7">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="col-sm-5 control-label text-black"><?php echo e(trans('events.S_freeSeatTotal')); ?></label>
                            <div class="col-sm-7">
                                            ...
                                            <div class="flex-column m-auto">
                                                ...
                                                <div class="stats-small__forms stats-small_forms__1">
                                                    ...
                                                    <div class="form-flex w-70" :style="{color :seatCardStyle(data.seatColor)}">
                                                        ...
                                                        <?php echo e(trans('events.S_SeatUnit')); ?>
                                                ...
                                                <div class="stats-small__form-group">
                                                    <div class="stats-small__forms stats-small_forms__1">
                                                        <div class="form-flex stats-small__one w-30">
                                                            ...
                                                            <!--<input type="" class="form-control in-small border__blue" id="" placeholder="<?php echo e(trans('events.S_holdSeatType')); ?>" readonly>-->
                                                        </div>
                                ...
                                <div class="row floor-settings"  v-show="tableHidden">
                                    <div class="col-md-12 d-flex-bt">
                                        <div class="form-group form-d-flex">
                                            ...
                                            <label class="d-h-spec" v-show="!statucControl[0].seat_setting">{{ nowUnitTotal }}<?php echo e(trans('events.S_SeatUnit')); ?></label>
                                            <!-- /.input group -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal" @click="closeDialog()"><?php echo e(trans('events.S_cancelBtn')); ?></button>
                ...
                <div class="modal-body">
                    <div class="row form-horizontal">
                        <center>
                            ...
                            <h4><?php echo e(trans('events.S_changeSeatMap')); ?></h4>
                        </center>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-default pull-left"  @click="reconfirmResult(false)"><?php echo e(trans('events.S_cancelBtn')); ?></button>
                    <button class="btn btn-danger" id="PasswordSend"  @click="reconfirmResult(true)"><?php echo e(trans('events.S_btnSaveMSG')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    const seatSetting = new Vue({
        ...
        mounted:function(){
            <?php if($eventData["status"] === 'edit' || count($errors) > 0): ?>
                sessionStorage.setItem('mapData','<?php echo (array_key_exists("mapData",$eventData))?addslashes($eventData["mapData"]):null; ?>')
            ...
            */
            ...
            specTicketValidate:function(data){
                ...
                if(typeof data.title == null || data.title.length <= 0){
                    errorMsg += '<?php echo e(trans("events.S_SeatErrMsg_01")); ?>'
                    status = false
                    ...
                    if(valideResult){
                        errorMsg += '<?php echo e(trans("events.S_SeatErrMsg_02")); ?> '
                        status = false
                        this.checkResult['specTicket']['title'] = true
                    }
                }
                ...
                if(typeof data.text == null || data.text.length <= 0){
                    ...
                    errorMsg += '<?php echo e(trans("events.S_SeatErrMsg_03")); ?> '
                    status = false
                    ...
                    if(valideResult){
                        ...
                        errorMsg += '<?php echo e(trans("events.S_SeatErrMsg_04")); ?>'
                        status = false
                        this.checkResult['specTicket']['text'] = true
                    }
                }
                ...
                if(data.color){
                    ...
                    if(valideResult){
                        ...
                        errorMsg += '<?php echo e(trans("events.S_SeatErrMsg_05")); ?>'
                        status = false
            ...
            uploadFile:function(){
                ...
                $.ajax({
                    url: '<?php echo e(url('/excel/import')); ?>',
                    type: 'POST',  
                    data: data,
                    cache: false,
                    processData: false,
...
<?php /**PATH /home/vagrant/code/gettiilite/resources/views/frontend/event/editLayout/seatSetting.blade.php ENDPATH**/ ?>