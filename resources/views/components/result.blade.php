                    ...
                    <div class="row form-horizontal">
                        <div class="col-md-12">
                            <!--儲存結果-->
                               ...
                               <!--0302 調整新增
                                <h3  v-else>
                                    <i class="fas fa-exclamation-circle text-yellow"></i> {{ trans('events.S_Warning') }}
                                </h3>
                                -->
                             <!--儲存結果-->
