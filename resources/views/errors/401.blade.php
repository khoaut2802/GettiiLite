...
<body class="bg-main">
        <div class="container">
            ...
            <div class="navbar">
                <div class="logo">
                    <a href="{{ URL::to('/') }}"><img src="{{ URL::to('/assets/images/error/logo.png') }}"  width="150px"></a>
                </div>
            </div>
            <!-- /.logo -->
            <!-- 標題文字區塊 -->
            <div class="error500-txt-box">
                <h2 class="animate-reveal animate-first">401 - Unauthorized</h2>
                <h3 class="animate-reveal animate-second">  
                    {{ trans('error.S_401ErrorTitle') }}
                </h3>
                <p class="animate-reveal animate-third">
                    {{ trans('error.S_401ErrorMainMesseger') }}
                </p>
            </div>
            <!-- /.標題文字區塊 -->
            <!--主視覺 -->
