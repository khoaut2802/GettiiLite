        ...
        <div class="form-horizontal">
            ...
            <div class="box no-border">
                ...
                <div class="box-header with-border-non">
                    <h3 class="box-title"> {{ trans('events.S_sellMethodTitle') }}</h3>
                </div>
                <!---/.box-header--->
                <!---box-body--->
                <div class="box-body">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-checkbox">
                                    <label class="control control--checkbox">
                                        <input type="checkbox" v-model="creditCard" :disabled="statucControl[0].pay_method">{{ trans('events.S_sellMethodCCTitle') }}
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                                <div class="form-group-flex col-sm-offset-1 mb-3">
                                    <label class="control-label">{{ trans('events.S_sellLimitTitle') }}</label>
                                    ...
                                    <label class="control-label">{{ trans('events.S_sellLimitUnit_01') }}</label>
                                </div>
                                <div class="col-md-11 col-sm-offset-1 form-checkbox-groupbox">
                                    <div class="form-checkbox-title">{{ trans('events.S_sellPickupTitle') }}</div>
                                        <!-- Disable mobapass at hotfix_R06 -->
                                        <div class="col-md-2 form-checkbox form-line-m10" v-show="onlineGetTicket">
                                        <label class="control control--checkbox">
                                            <input type="checkbox" v-model="onlineGetTicket" :disabled="onlineGetTicket || statucControl[0].pickup_method || !creditCard">{{ trans('events.S_sellPickupMobapass') }}
                                            <div class="control__indicator"></div>
                                        </label>
                                        </div>
                                    ...
                                    <div class="col-md-3 form-checkbox form-line-m10">
                                          <label class="control control--checkbox">
                                              <input type="checkbox" v-model="resuq" :disabled="statucControl[0].pickup_method || !creditCard">{{ trans('events.S_sellPickupResuq') }}
                                              <div class="control__indicator"></div>
                                          </label>
                                      </div>
                                    @endif
                                    ...
                                    <div class="col-md-3 form-checkbox form-line-m10">
                                          <label class="control control--checkbox">
                                              <input type="checkbox" v-model="noTicketing" :disabled="statucControl[0].pickup_method || !creditCard">{{ trans('events.S_sellPickupNoTicketing') }}
                                              <div class="control__indicator"></div>
                                          </label>
                                      </div>
                                    <!--
                                    <div class="form-checkbox form-line-m10">
                                        <label class="control control--checkbox">
                                            <input type="checkbox" v-model="onlineGetTicket" :disabled="statucControl[0].pickup_method">{{ trans('events.S_sellPickupMobapass') }}
                                            <div class="control__indicator"></div>
                                        </label>
                                        <label class="control control--checkbox">
                                    ...
                                    {{-- <div class="form-checkbox form-line-m10">
                                        <label class="control control--checkbox">
                                            <input type="checkbox" v-model="getTicket" :disabled="statucControl[0].pickup_method">{{ trans('events.S_sellPickupConvenience') }}
                                            <div class="control__indicator"></div>
                                        </label>
                                    </div> --}}
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-checkbox-title">{{ trans('events.S_sellPickupTitle') }}</div>
                                      ...
                                      <div class="col-md-3 form-checkbox form-line-m10">
                                          <label class="control control--checkbox">
                                              <input type="checkbox" v-model="resuqSEJ" :disabled="statucControl[0].basis || !sevenElevenGetTicket">{{ trans('events.S_sellPickupResuq') }}
                                              <div class="control__indicator"></div>
                                          </label>
                                      </div> 
                                    <!-- 不發券 -->
                                    <div class="col-md-3 form-checkbox form-line-m10">
                                          <label class="control control--checkbox">
                                              <input type="checkbox" v-model="noTicketingSEJ" :disabled="statucControl[0].basis || !sevenElevenGetTicket">{{ trans('events.S_sellPickupNoTicketing') }}
                                              <div class="control__indicator"></div>
                                          </label>
                                      </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="form-checkbox">
                                    <label class="control control--checkbox">
                                        <input type="checkbox" v-model="payCash" :disabled="statucControl[0].pay_method">{{ trans('events.S_sellMethodConvenienceTitle') }}
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                                <div class="form-group-flex col-sm-offset-1  mb-3">
                                    <label class="control-label">{{ trans('events.S_sellLimitTitle') }}</label>
                                    <div class="col-md-2 w-15">
                                        <input type="" class="form-control" v-model="payCashLimit" :disabled="statucControl[0].receive_limit">
                                    </div>
                                    <div class="txt-flex-mr">{{ trans('events.S_sellLimitUnit_01') }}</div>
                                </div>
                                <!---->
                                <div class="form-group-flex col-sm-offset-1 mb-3">
                                    <label class="control-label">{{ trans('events.S_sellPickupDateTitle') }}</label>
                                    <div class="col-md-10 w-50">
                                        <div class="input-group">
                                            <input type="text" class="form-control pull-left" id="sellDate" :disabled="statucControl[0].treat_end_date">
                                ...
                                <!---->
                                <div class="form-group-flex col-sm-offset-1 mb-3">
                                    <label class="control-label">{{ trans('events.S_sellPickupTermTitle') }}</label>
                                    <div class="col-md-2 w-15">
                                        <input type="" class="form-control" v-model="cashDateLimit" :disabled="statucControl[0].reserve_period">
                                    </div>
                                    <div class="txt-flex-mr">{{ trans('events.S_sellPickupTermUnit_01') }}
                                    </div>
                                </div>
                            </div>
                        </div> 
                        <!-- /.2 -->
                        <div class="col-sm-offset-1 from-memo-list">
                                {!! trans('events.S_sellPickupTermNote_01') !!}
                        </div>
                        --}}
                ...
                <div class="box-footer">
                    ...
                    <div class="col-md-12">
                        <h5>{{ trans('events.S_sellMemberLimitTitle') }}</h5>
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <div class="col-sm-10 txt-flex-mr">{{ trans('events.S_sellLimitUnit_02') }}</div>
                        </div>
                        </div>
                        <!-- /.form-group -->
                    </div>
    ...
    var sellSetting = new Vue({
        ...
        mounted(){
            @if($eventData["status"] === 'edit' || count($errors) > 0)   
                sessionStorage.setItem('sellSetting','{!! addslashes($eventData["sellSetting"]) !!}')
