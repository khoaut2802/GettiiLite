            ...
            <!--<div class="box-header with-border">
                ...
                <div class="step-box-body">
                    ...
                    <div class="ticket-tab">
                        ...
                        <label for="tab1" v-show="sellSetting.onlineGetTicket">{{ trans('events.S_mobapass') }}</label>
                        ...
                        <div class="tab-panels">
                            <section id="mobapass" class="tab-panel" v-show="sellSetting.onlineGetTicket">
                                ...
                                <div class="col-md-5 step-section-gray">
                                    <div class="step-title">{{ trans('events.S_preview') }}</div>
                                    <div class="step-content">
                                        <div class="mobile-preview">
                                            <div class="mobile" style="background: url('{{ URL::to('/assets/images/mobapass/img-mobile.png') }}') no-repeat #fff;background-size: 100%;">
                                                <!---->
                                                <div class="mobile-content">
                                                    <hgroup>
                                                        <div class="mobile-content__header" style="background: url('{{ URL::to('/assets/images/mobapass/img-mobile-header.png') }}') no-repeat #fff;background-size: 100%;"></div>
                                                        ...
                                                        <div class="main-section">
                                                            ...
                                                            <p>@{{ ticketView['date'] }}</p>
                                                            <p class="pl-15">{{ trans('events.S_showTime') }}@{{ ticketView['time'] }}</p>
                                                        ...
                                                        <div class="mobile-content__tabbar" style="background: url('{{ URL::to('/assets/images/mobapass/img-mobile-tabbar.png') }}') no-repeat #fff;background-size: 100%;"></div>
                                                    </hgroup>
                                                </div>
                                                <!---->
                                            </div>
                                ...
                                <div class="col-md-7">
                                    <!-- BLOCK2 -->
                                    <div class="col-md-12">
                                        <div class="step-title flex-start">{{ trans('events.S_displayPIC') }}
                                            <div class="tip"><span data-tooltip="{{trans('events.S_eventImageNoticeMbps')}}"><i class="fas fa-info fa-1x fa__thead"></i></span></div>
                                        </div>
                                        <div class="step-content">
                                    ...
                                    <!-- BLOCK1 -->
                                    <div class="col-md-12">
                                        <div class="step-title">{{ trans('events.S_displayMemo') }}</div>
                                        <div class="step-content">
                                        <!---->
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <select class="form-control select2" @change="stageMsn($event)" v-model="mobapassDate" style="width: 100%;">
                                                        <option value="all">{{ trans('events.S_defaultMSG') }}</option>
                                            ...
                                            <div class="btn-footer text-left">
                                                <button type="button" class="btn btn-block btn-rounded btn-ll waves-effect waves-light btn-info" v-show="!statucControl[0].free_word" v-on:click="updateMobapassData()">{{ trans('events.S_btnSaveMSG') }}</button>
                                            </div>
                                            <!---->
                                        </div>
                                    </div>
                            ...
                            <section id="qrpass" class="tab-panel" v-show="sellSetting.qrPassEmail || sellSetting.qrPassSms">
                                ...
                                <div class="col-md-5 step-section-gray">
                                    ...
                                    <div class="step-content step-imgblock">
                                        <div class="mobile-preview">
                                            <img src="{{ URL::to('/assets/images/mobapass/img-qrpass.png') }}">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.BLOCK3 -->
                            ...
                            <section id="ibon" class="tab-panel" v-show="sellSetting.ibon || sellSetting.ibonGetTicket">
                                ...
                                <div class="col-md-5 step-section-gray">
                                    ...
                                    <div class="step-content step-imgblock">
                                        <div class="mobile-preview">
                                            <img src="{{ URL::to('/assets/images/mobapass/img-ibon.png') }}">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.BLOCK3 -->
                            ...
                            <section id="seven-eleven" class="tab-panel"  v-show="sellSetting.sevenEleven || sellSetting.sevenElevenGetTicket">
                                ...
                                <div class="col col-sm-12 col-md-7 col-set-100 step-section-gray">
                                    ...
                                    <div class="step-content step-imgblock">
                                        <div class="mobile-preview">
                                            <!-- 0605調整 -->
                                            <div class="step-title">タイプ @{{ sevenElevenTemplate }} ｜ {{ trans('events.S_preview') }}</div>
                                            <div class="small-i">
                                            <div class="tip">
                                                <span>
                                        ...
                                        <div class="step-content">
                                            <!--form2-->
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <span class="help is-danger" v-show="sevenElevenTitle && sevenElevenTitle != sevenElevenTitle.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                                    </div>                                                
                                                </div>
                                            <!--/.form2-->
                                            <!-- -->
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <!-- STS 2021/07/26 task 38 -->
                                                    <span class="help is-danger" v-show="sevenElevenMessage1 && sevenElevenMessage1 != sevenElevenMessage1.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                                    ...
                                                    <span v-show="errors.has('seven-eleven-message2')" class="help is-danger"><i class="fas fa-exclamation-circle"></i> @{{ errors.first('seven-eleven-message2') }}</span>
                                                     <!-- STS 2021/07/26 task 38 -->
                                                    <span class="help is-danger" v-show="sevenElevenMessage2 && sevenElevenMessage2 != sevenElevenMessage2.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                                </div>
                                            </div>
                                            <div class="btn-footer text-left">
    ...
    var ticketViewSetting = new Vue({
            ...
            */
            ...
            getTicketViewInf:function(calenderParentId = 0, calenderId = 0){
                ...
                if(calender['specTitle'] == '' || calender['specTitle'] == null)
                {
                  ...
                  calender['mbpsTime'] = calender['stage'] + calender['time'] +' '+ '{{ trans('events.S_showTime') }}';
                }else{
                ...
                for(floatId in map){ 
                    ...
                    for(blockId in float.blockData){
                        ...
                        seat['block'] = block.blockTittle.toString() /*+  '{{(\App::getLocale() == "ja" )? 'ブロック':'區'}}'*/
                ...
                var displayOT = calender['date']+' '+calender['time']+' '+'{{ trans('events.S_showTime') }}'
                ...
                var displayT2SS = calender['stage']
                 if(calender['specTitle'] != null && calender['specTitle'] != '') {
                    ...
                    displayT2SS += calender['time']+'　'+'{{ trans('events.S_showTime') }}'
                }
                var floor = ''
                var block = ''
                var gate = ''
        ...
        mounted(){
            @if( $eventData["status"] === 'edit' || count($errors) > 0 )   
                sessionStorage.setItem('ticketViewSetting','{!! addslashes($eventData["ticketViewContent"]) !!}')
