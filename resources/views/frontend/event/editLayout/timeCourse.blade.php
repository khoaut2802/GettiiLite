    ...
    <div class="time-course-wrap">
        <div class="form-horizontal">
            ...
            <div class="callout callout-info">
                <h4>{{ trans('events.S_stageMainTitle') }}</h4>
                {!! trans('events.S_stageMainDesc') !!}
            </div>
            <!--/.錯誤提示-->
                    ...
                    <div class="">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group form-group-flex mb-0">
                                <div class="form-checkbox">
                                    <label class="control control--radio">
                                        ...
                                        {{ trans('events.S_SpecificDateSelect') }}
                            ...
                            <div class="form-group" v-show="(settingRadio == 'spec') ? true : false">
                                <label class="col-md-2 control-label">{{ trans('events.S_evensShowDate') }}<b>{{trans('events.S_RequiredMark')}}</b></label>
                                <div class="col-md-10 has-feedback form-feedback">
                                    <input name="spec-title" type="text" maxlength="30" v-model="specTitle" v-validate="'sej_format:8'"  v-bind:style="{ borderColor: (checkResult['specTitle'].status)?'#e44e2d':'' }" v-on:blur="specTitleChange()" :disabled="statucControl[0].basis" class="form-control" placeholder="{{ trans('events.S_evensShowDatePlaceholder') }}">
                                    ...
                                    <span class="help is-danger" v-show="specTitle && specTitle != specTitle.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                </div>
                            </div>
                            <!-- /.Form + form-feedback -->
                            <!-- //Form + timepicker-->
                            <div class="form-group" v-show="(settingRadio == 'spec') ? true : false">
                                <label class="col-md-2 control-label">{{ trans('events.S_stageDailyTime') }}</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group" v-show="(settingRadio == 'spec') ? true : false">
                                <label class="col-md-2 control-label">{{ trans('events.S_stageDailyTimeDisp') }}</label>
                                <div class="col-md-9 has-feedback form-feedback">
                                    <input dusk="event-spec-even-title" maxlength="20" type="text" class="form-control" v-model="specEvenTitle" v-on:blur="specEvenTitleChange()" placeholder="{{ trans('events.S_stageShowTimeDispPlaceholder') }}">
                                </div>
                                <div class="col-md-1 form-checkbox">
                                    <label class="control control--checkbox mtb-1 pull-right">
                                        <input type="checkbox" v-model="specEvenStatus" v-on:change="specEvenStatusChange()"> {{ trans('events.S_display') }}
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group form-group-flex mb-0">
                    <div class="form-checkbox">
                        <label class="control control--radio">
                            ...
                            {{ trans('events.S_BasisDateSetting') }}
                            <div class="control__indicator"></div>
                        </label>
                    </div>
                </div>
                ...
                <div class="box no-border ml-15x" v-show="(settingRadio == 'normal') ? true : false ">
                    <div class="box-header with-border-non"  data-widget="collapse">
                        <h3 class="box-title">{{ trans('events.S_stageNameSettingTitle') }}</h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body">
                        <template v-for="(rule, index) in ruleInf">
                            <div class="form-group flex-around" v-if="!rule.del">
                                <label class="col-md-2 control-label">{{ trans('events.S_stage') }} - @{{ rule.id }}</label>
                                <div class="col-md-9 has-feedback form-feedback">
                                    ...
                                    <!-- STS 2021/07/26 task 38 -->
                                    <span class="help is-danger" v-show="rule.title && rule.title != rule.title.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                </div>
                                ...
                                <!-- <div class="col-md-1 form-checkbox">
                                    <label class="control control--checkbox mtb-1 pull-right">
                                        <input type="checkbox" v-model="rule.status"> {{ trans('events.S_display') }}
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>-->
                            </div>
                ...
                <div class="box no-border ml-15x" v-show="!statucControl[0].timeSetting">
                    ...
                    <div class="box-body">
                                ...
                                <div class="">
                                    <div class="form-checkbox pl-15">
                                        <label class="control control--radio col-md-2">
                                            ...
                                            {{ trans('events.S_BasisWeekSetting') }}
                                            <div class="control__indicator"></div>
                                        </label>
                                    </div>
                                    <!---->
                                    ...
                                    <template v-if="(dateSelect == 'week') ? true : false ">
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                                <input dusk="week-mon" type="checkbox" value="" v-model="mon"> {{ trans('events.S_stageWeek_Mon') }}
                                                <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                            <input dusk="week-tue" type="checkbox" value="" v-model="tue"> {{ trans('events.S_stageWeek_Tue') }}
                                            <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                            <input dusk="week-wed" type="checkbox" value="" v-model="wed"> {{ trans('events.S_stageWeek_Wed') }}
                                            <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                            <input dusk="week-thu" type="checkbox" value="" v-model="thu"> {{ trans('events.S_stageWeek_Thu') }}
                                            <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                            <input dusk="week-fri" type="checkbox" value="" v-model="fri"> {{ trans('events.S_stageWeek_Fri') }}
                                            <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                            <input dusk="week-sat" type="checkbox" value="" v-model="sat"> {{ trans('events.S_stageWeek_San') }}
                                            <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                                        <div class="form-checkbox form-checkbox-fix">
                                            <label class="control control--checkbox">
                                                <input id="date-set-week-sun" dusk="week-sun" type="checkbox" value="" v-model="sun"> {{ trans('events.S_stageWeek_Sun') }}
                                                <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <!---->
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="col-md-4 control-label">{{ trans('events.S_stage') }}
                                </label>
                                <div class="col-md-8 pl-20">
                                    <select id="ruleNum" class="form-control" @change="ruleNoChange()" v-model="ruleNo">
                                        <option  value="-1" disabled>{{ trans('events.S_select') }}</option>
                            ...
                            <div class="col-md-6">
                                <div class="">
                                    <label class="col-md-4 control-label">{{ trans('events.S_stageShowTime') }}</label>
                                    <div class="col-md-8">
                                        <div class="input-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label class="col-md-2 control-label">{{ trans('events.S_evensShowDate') }}</label>
                                <div class="col-md-10 has-feedback form-feedback">
                                    ...
                                    <!-- STS 2021/07/26 task 38 -->
                                    <span class="help is-danger" v-show="dateTitle && dateTitle != dateTitle.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                </div>
                            </div>
                        </div>
                        <!-- /.Form + form-feedback-->
                        <!-- <div class="col-md-12" @click="ruleAdd" @mouseover="disabledBtn">
                            <button  id="date-import-btn" type="button" class="btn btn-block waves-effect waves-light btn-rounded btn-inverse" :disabled="cheackData || ruleNo < 0 || errors.has('even-date-tittle')">
                                {{ trans('events.S_DateSettingAddButton') }}
                        ...
                        <div class="box-body">
                            <div class="table-responsive" v-show="(settingRadio == 'spec') ? false : true ">
                                <table class="table table-striped table-boxrows">
                                    <thead>
                                        <tr>
                                            <th width="20%"> {{ trans('events.S_stageDateTitle') }}</th>
                                            <th width="">
                                                <div class="col-sm-4">{{ trans('events.S_stageTimeTitle') }}</div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('events.S_stageDateTitle') }} ： @{{ ModalData.date}} </h4>
                    </div>
                <div class="modal-body">
                    <div class="row form-horizontal">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                        <label class="col-md-4 control-label">{{ trans('events.S_stage') }}</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">{{ trans('events.S_stageShowTimeDisp') }}</label>
                                    <div class="col-md-10">
                                        ...
                                        <!-- STS 2021/07/26 task 38 -->
                                        <span class="help is-danger" v-show="evenDateTitle && evenDateTitle != evenDateTitle.replace(/-+/g,'-') "><i class="fas fa-exclamation-circle"></i> {{ trans('events.S_basicerrorMsn') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer" @mouseover="disabledInsBtn">
                    ...
                    @if($eventData['performanceDispStatus'] >= 0 && $eventData['performanceDispStatus'] < 7)
                       <!-- STS 2021/07/27 task 38 --START -->
                ...
                <div class="modal-body">
                    <div class="row form-horizontal">
                        <center>
                            ...
                            <h4>{{ trans('events.S_deleteSession') }}</h4>
                        </center>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-default pull-left"  @click="reconfirmResult(false)">{{ trans('events.S_cancelBtn') }}</button>
                    <button class="btn btn-danger" id="PasswordSend"  @click="reconfirmResult(true)">{{ trans('events.S_deleteBtn') }}</button>
                </div>
            </div>
        </div>
    </div>
...
<template id="ruleItem">
    <div class="form-group">
        ...
        <div class="col-md-1 form-checkbox">
            <label class="control control--checkbox mtb-1 pull-right">
                <input type="checkbox" v-model="status" @click="statusChange()"> {{ trans('events.S_display') }}
                <div class="control__indicator"></div>
            </label>
        </div>
    </div>
        ...
        <button class="card card-wite card-xs stats-xs" @click="setting(item)">
            ...
            <div class="card-body" style="opacity: .4;">
                <div class="box-column">
                    ...
                    <div class="card-content">
                        <div class="card-content-time">@{{ item.time }}</div> 
                        <div class="card-content-sub" style="color: #fe6882;">{{ trans('events.S_delete') }}</div>
                    </div>
                </div>
            </div>
        </button>
...
@if (!empty($eventData["timeTitle"]))
sessionStorage.setItem('ruleData','{!! addslashes($eventData["timeTitle"]) !!}')
@endif

@if (!empty($eventData["calenderData"]))
sessionStorage.setItem('calenderData','{!! addslashes($eventData["calenderData"]) !!}')
@endif
...
var timeCourse = new Vue({
  ...
  methods: {
    ...
    ruleDel: function(){
        ...
        //強制更新 element
        this.$forceUpdate()
        if([5, 6, 8, 7].includes(parseInt('{{ $eventData['performanceDispStatus'] }}', 10))){
            this.setStageRange()
        }
    },
  ...
  mounted(){
    @if($eventData["status"] === 'edit' || count($errors) > 0)
        this.settingRadio = '{{ isset($eventData["timeStatus"]["0"]["status"])?$eventData["timeStatus"]["0"]["status"]:"spec" }}'
        this.MinDateRangeStar = '{{ isset($eventData["timeStatus"]["0"]["minDate"])?$eventData["timeStatus"]["0"]["minDate"]:"" }}'
        this.MaxDateRangeEnd = '{{ isset($eventData["timeStatus"]["0"]["maxDate"])?$eventData["timeStatus"]["0"]["maxDate"]:"" }}'
        let perfomanceStatus = parseInt('{{ $eventData['performanceDispStatus'] }}', 10)
         
        @if ($eventData["specDate"] !== "null")
            sessionStorage.setItem('specDate','{!! addslashes($eventData["specDate"]) !!}')
