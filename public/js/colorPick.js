...
(function( $ ) {
    ...
    $.colorPick = function (element, options) {
        ...
        var dataColor = this.element.data( "color" );
        var id = '#'+this.element.data('code');
        console.log(id , dataColor)
        //$(id).style.backgroundColor =  dataColor;
        
        if(dataColor){
            dataInitialColor = dataColor;
        }

        color = dataInitialColor
        ...
        init : function(){
            ...
            this.element.click(function(event) {
                ...
                $('.colorPickButton').click(function(event) {
                    //let position = self.element.data( "position" );
                    //$(".col-seat-setting")[position].style.backgroundColor =  $(event.target).attr('hexValue');
